...
#ifdef VIRTUALBOX_VM
# ifdef RT_OS_DARWIN
    fFlags |= SUPSECMAIN_FLAGS_LOC_OSX_HLP_APP | SUPSECMAIN_FLAGS_OSX_VM_APP;
# endif
    return SUPR3HardenedMain("VirtualBoxVM", fFlags | SUPSECMAIN_FLAGS_TRUSTED_ERROR, argc, argv, envp);
#else
