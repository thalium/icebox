...
namespace
{
	static const nt32::callcfg_t g_callcfgs[] =
	{
        {"_NtAcceptConnectPort@24", 6, {{"PHANDLE", "PortHandle"}, {"PVOID", "PortContext"}, {"PPORT_MESSAGE", "ConnectionRequest"}, {"BOOLEAN", "AcceptConnection"}, {"PPORT_VIEW", "ServerView"}, {"PREMOTE_PORT_VIEW", "ClientView"}}},
        ...
        {"_NtAccessCheckByTypeResultList@44", 11, {{"PSECURITY_DESCRIPTOR", "SecurityDescriptor"}, {"PSID", "PrincipalSelfSid"}, {"HANDLE", "ClientToken"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_TYPE_LIST", "ObjectTypeList"}, {"ULONG", "ObjectTypeListLength"}, {"PGENERIC_MAPPING", "GenericMapping"}, {"PPRIVILEGE_SET", "PrivilegeSet"}, {"PULONG", "PrivilegeSetLength"}, {"PACCESS_MASK", "GrantedAccess"}, {"PNTSTATUS", "AccessStatus"}}},
        {"_NtAccessCheck@32", 8, {{"PSECURITY_DESCRIPTOR", "SecurityDescriptor"}, {"HANDLE", "ClientToken"}, {"ACCESS_MASK", "DesiredAccess"}, {"PGENERIC_MAPPING", "GenericMapping"}, {"PPRIVILEGE_SET", "PrivilegeSet"}, {"PULONG", "PrivilegeSetLength"}, {"PACCESS_MASK", "GrantedAccess"}, {"PNTSTATUS", "AccessStatus"}}},
        {"_NtAddAtom@12", 3, {{"PWSTR", "AtomName"}, {"ULONG", "Length"}, {"PRTL_ATOM", "Atom"}}},
        {"_ZwAddBootEntry@8", 2, {{"PBOOT_ENTRY", "BootEntry"}, {"PULONG", "Id"}}},
        {"_NtAddDriverEntry@8", 2, {{"PEFI_DRIVER_ENTRY", "DriverEntry"}, {"PULONG", "Id"}}},
        {"_ZwAdjustGroupsToken@24", 6, {{"HANDLE", "TokenHandle"}, {"BOOLEAN", "ResetToDefault"}, {"PTOKEN_GROUPS", "NewState"}, {"ULONG", "BufferLength"}, {"PTOKEN_GROUPS", "PreviousState"}, {"PULONG", "ReturnLength"}}},
        {"_ZwAdjustPrivilegesToken@24", 6, {{"HANDLE", "TokenHandle"}, {"BOOLEAN", "DisableAllPrivileges"}, {"PTOKEN_PRIVILEGES", "NewState"}, {"ULONG", "BufferLength"}, {"PTOKEN_PRIVILEGES", "PreviousState"}, {"PULONG", "ReturnLength"}}},
        {"_NtAlertResumeThread@8", 2, {{"HANDLE", "ThreadHandle"}, {"PULONG", "PreviousSuspendCount"}}},
        {"_NtAlertThread@4", 1, {{"HANDLE", "ThreadHandle"}}},
        {"_ZwAllocateLocallyUniqueId@4", 1, {{"PLUID", "Luid"}}},
        {"_NtAllocateReserveObject@12", 3, {{"PHANDLE", "MemoryReserveHandle"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"MEMORY_RESERVE_TYPE", "Type"}}},
        {"_NtAllocateUserPhysicalPages@12", 3, {{"HANDLE", "ProcessHandle"}, {"PULONG_PTR", "NumberOfPages"}, {"PULONG_PTR", "UserPfnArra"}}},
        {"_NtAllocateUuids@16", 4, {{"PULARGE_INTEGER", "Time"}, {"PULONG", "Range"}, {"PULONG", "Sequence"}, {"PCHAR", "Seed"}}},
        {"_NtAllocateVirtualMemory@24", 6, {{"HANDLE", "ProcessHandle"}, {"PVOID", "STARBaseAddress"}, {"ULONG_PTR", "ZeroBits"}, {"PSIZE_T", "RegionSize"}, {"ULONG", "AllocationType"}, {"ULONG", "Protect"}}},
        {"_NtAlpcAcceptConnectPort@36", 9, {{"PHANDLE", "PortHandle"}, {"HANDLE", "ConnectionPortHandle"}, {"ULONG", "Flags"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PALPC_PORT_ATTRIBUTES", "PortAttributes"}, {"PVOID", "PortContext"}, {"PPORT_MESSAGE", "ConnectionRequest"}, {"PALPC_MESSAGE_ATTRIBUTES", "ConnectionMessageAttributes"}, {"BOOLEAN", "AcceptConnection"}}},
        {"_ZwAlpcCancelMessage@12", 3, {{"HANDLE", "PortHandle"}, {"ULONG", "Flags"}, {"PALPC_CONTEXT_ATTR", "MessageContext"}}},
        {"_ZwAlpcConnectPort@44", 11, {{"PHANDLE", "PortHandle"}, {"PUNICODE_STRING", "PortName"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PALPC_PORT_ATTRIBUTES", "PortAttributes"}, {"ULONG", "Flags"}, {"PSID", "RequiredServerSid"}, {"PPORT_MESSAGE", "ConnectionMessage"}, {"PULONG", "BufferLength"}, {"PALPC_MESSAGE_ATTRIBUTES", "OutMessageAttributes"}, {"PALPC_MESSAGE_ATTRIBUTES", "InMessageAttributes"}, {"PLARGE_INTEGER", "Timeout"}}},
        {"_ZwAlpcCreatePort@12", 3, {{"PHANDLE", "PortHandle"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PALPC_PORT_ATTRIBUTES", "PortAttributes"}}},
        {"_NtAlpcCreatePortSection@24", 6, {{"HANDLE", "PortHandle"}, {"ULONG", "Flags"}, {"HANDLE", "SectionHandle"}, {"SIZE_T", "SectionSize"}, {"PALPC_HANDLE", "AlpcSectionHandle"}, {"PSIZE_T", "ActualSectionSize"}}},
        {"_ZwAlpcCreateResourceReserve@16", 4, {{"HANDLE", "PortHandle"}, {"ULONG", "Flags"}, {"SIZE_T", "MessageSize"}, {"PALPC_HANDLE", "ResourceId"}}},
        {"_ZwAlpcCreateSectionView@12", 3, {{"HANDLE", "PortHandle"}, {"ULONG", "Flags"}, {"PALPC_DATA_VIEW_ATTR", "ViewAttributes"}}},
        {"_ZwAlpcCreateSecurityContext@12", 3, {{"HANDLE", "PortHandle"}, {"ULONG", "Flags"}, {"PALPC_SECURITY_ATTR", "SecurityAttribute"}}},
        {"_ZwAlpcDeletePortSection@12", 3, {{"HANDLE", "PortHandle"}, {"ULONG", "Flags"}, {"ALPC_HANDLE", "SectionHandle"}}},
        {"_NtAlpcDeleteResourceReserve@12", 3, {{"HANDLE", "PortHandle"}, {"ULONG", "Flags"}, {"ALPC_HANDLE", "ResourceId"}}},
        {"_NtAlpcDeleteSectionView@12", 3, {{"HANDLE", "PortHandle"}, {"ULONG", "Flags"}, {"PVOID", "ViewBase"}}},
        {"_NtAlpcDeleteSecurityContext@12", 3, {{"HANDLE", "PortHandle"}, {"ULONG", "Flags"}, {"ALPC_HANDLE", "ContextHandle"}}},
        {"_NtAlpcDisconnectPort@8", 2, {{"HANDLE", "PortHandle"}, {"ULONG", "Flags"}}},
        {"_ZwAlpcImpersonateClientOfPort@12", 3, {{"HANDLE", "PortHandle"}, {"PPORT_MESSAGE", "PortMessage"}, {"PVOID", "Reserved"}}},
        {"_ZwAlpcOpenSenderProcess@24", 6, {{"PHANDLE", "ProcessHandle"}, {"HANDLE", "PortHandle"}, {"PPORT_MESSAGE", "PortMessage"}, {"ULONG", "Flags"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_ZwAlpcOpenSenderThread@24", 6, {{"PHANDLE", "ThreadHandle"}, {"HANDLE", "PortHandle"}, {"PPORT_MESSAGE", "PortMessage"}, {"ULONG", "Flags"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_ZwAlpcQueryInformation@20", 5, {{"HANDLE", "PortHandle"}, {"ALPC_PORT_INFORMATION_CLASS", "PortInformationClass"}, {"PVOID", "PortInformation"}, {"ULONG", "Length"}, {"PULONG", "ReturnLength"}}},
        {"_ZwAlpcQueryInformationMessage@24", 6, {{"HANDLE", "PortHandle"}, {"PPORT_MESSAGE", "PortMessage"}, {"ALPC_MESSAGE_INFORMATION_CLASS", "MessageInformationClass"}, {"PVOID", "MessageInformation"}, {"ULONG", "Length"}, {"PULONG", "ReturnLength"}}},
        {"_NtAlpcRevokeSecurityContext@12", 3, {{"HANDLE", "PortHandle"}, {"ULONG", "Flags"}, {"ALPC_HANDLE", "ContextHandle"}}},
        {"_NtAlpcSendWaitReceivePort@32", 8, {{"HANDLE", "PortHandle"}, {"ULONG", "Flags"}, {"PPORT_MESSAGE", "SendMessage"}, {"PALPC_MESSAGE_ATTRIBUTES", "SendMessageAttributes"}, {"PPORT_MESSAGE", "ReceiveMessage"}, {"PULONG", "BufferLength"}, {"PALPC_MESSAGE_ATTRIBUTES", "ReceiveMessageAttributes"}, {"PLARGE_INTEGER", "Timeout"}}},
        {"_NtAlpcSetInformation@16", 4, {{"HANDLE", "PortHandle"}, {"ALPC_PORT_INFORMATION_CLASS", "PortInformationClass"}, {"PVOID", "PortInformation"}, {"ULONG", "Length"}}},
        {"_NtApphelpCacheControl@8", 2, {{"APPHELPCOMMAND", "type"}, {"PVOID", "buf"}}},
        {"_ZwAreMappedFilesTheSame@8", 2, {{"PVOID", "File1MappedAsAnImage"}, {"PVOID", "File2MappedAsFile"}}},
        {"_ZwAssignProcessToJobObject@8", 2, {{"HANDLE", "JobHandle"}, {"HANDLE", "ProcessHandle"}}},
        {"_NtCancelIoFileEx@12", 3, {{"HANDLE", "FileHandle"}, {"PIO_STATUS_BLOCK", "IoRequestToCancel"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}}},
        {"_ZwCancelIoFile@8", 2, {{"HANDLE", "FileHandle"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}}},
        {"_NtCancelSynchronousIoFile@12", 3, {{"HANDLE", "ThreadHandle"}, {"PIO_STATUS_BLOCK", "IoRequestToCancel"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}}},
        {"_ZwCancelTimer@8", 2, {{"HANDLE", "TimerHandle"}, {"PBOOLEAN", "CurrentState"}}},
        {"_NtClearEvent@4", 1, {{"HANDLE", "EventHandle"}}},
        {"_NtClose@4", 1, {{"HANDLE", "Handle"}}},
        {"_ZwCloseObjectAuditAlarm@12", 3, {{"PUNICODE_STRING", "SubsystemName"}, {"PVOID", "HandleId"}, {"BOOLEAN", "GenerateOnClose"}}},
        {"_ZwCommitComplete@8", 2, {{"HANDLE", "EnlistmentHandle"}, {"PLARGE_INTEGER", "TmVirtualClock"}}},
        {"_NtCommitEnlistment@8", 2, {{"HANDLE", "EnlistmentHandle"}, {"PLARGE_INTEGER", "TmVirtualClock"}}},
        {"_NtCommitTransaction@8", 2, {{"HANDLE", "TransactionHandle"}, {"BOOLEAN", "Wait"}}},
        {"_NtCompactKeys@8", 2, {{"ULONG", "Count"}, {"HANDLE", "KeyArray"}}},
        {"_ZwCompareTokens@12", 3, {{"HANDLE", "FirstTokenHandle"}, {"HANDLE", "SecondTokenHandle"}, {"PBOOLEAN", "Equal"}}},
        {"_NtCompleteConnectPort@4", 1, {{"HANDLE", "PortHandle"}}},
        {"_ZwCompressKey@4", 1, {{"HANDLE", "Key"}}},
        {"_NtConnectPort@32", 8, {{"PHANDLE", "PortHandle"}, {"PUNICODE_STRING", "PortName"}, {"PSECURITY_QUALITY_OF_SERVICE", "SecurityQos"}, {"PPORT_VIEW", "ClientView"}, {"PREMOTE_PORT_VIEW", "ServerView"}, {"PULONG", "MaxMessageLength"}, {"PVOID", "ConnectionInformation"}, {"PULONG", "ConnectionInformationLength"}}},
        {"_ZwContinue@8", 2, {{"PCONTEXT", "ContextRecord"}, {"BOOLEAN", "TestAlert"}}},
        {"_ZwCreateDebugObject@16", 4, {{"PHANDLE", "DebugObjectHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"ULONG", "Flags"}}},
        {"_ZwCreateDirectoryObject@12", 3, {{"PHANDLE", "DirectoryHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_ZwCreateEnlistment@32", 8, {{"PHANDLE", "EnlistmentHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"HANDLE", "ResourceManagerHandle"}, {"HANDLE", "TransactionHandle"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"ULONG", "CreateOptions"}, {"NOTIFICATION_MASK", "NotificationMask"}, {"PVOID", "EnlistmentKey"}}},
        {"_NtCreateEvent@20", 5, {{"PHANDLE", "EventHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"EVENT_TYPE", "EventType"}, {"BOOLEAN", "InitialState"}}},
        {"_NtCreateEventPair@12", 3, {{"PHANDLE", "EventPairHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_NtCreateFile@44", 11, {{"PHANDLE", "FileHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PLARGE_INTEGER", "AllocationSize"}, {"ULONG", "FileAttributes"}, {"ULONG", "ShareAccess"}, {"ULONG", "CreateDisposition"}, {"ULONG", "CreateOptions"}, {"PVOID", "EaBuffer"}, {"ULONG", "EaLength"}}},
        {"_NtCreateIoCompletion@16", 4, {{"PHANDLE", "IoCompletionHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"ULONG", "Count"}}},
        {"_ZwCreateJobObject@12", 3, {{"PHANDLE", "JobHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_NtCreateJobSet@12", 3, {{"ULONG", "NumJob"}, {"PJOB_SET_ARRAY", "UserJobSet"}, {"ULONG", "Flags"}}},
        {"_ZwCreateKeyedEvent@16", 4, {{"PHANDLE", "KeyedEventHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"ULONG", "Flags"}}},
        {"_ZwCreateKey@28", 7, {{"PHANDLE", "KeyHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"ULONG", "TitleIndex"}, {"PUNICODE_STRING", "Class"}, {"ULONG", "CreateOptions"}, {"PULONG", "Disposition"}}},
        {"_NtCreateKeyTransacted@32", 8, {{"PHANDLE", "KeyHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"ULONG", "TitleIndex"}, {"PUNICODE_STRING", "Class"}, {"ULONG", "CreateOptions"}, {"HANDLE", "TransactionHandle"}, {"PULONG", "Disposition"}}},
        {"_ZwCreateMailslotFile@32", 8, {{"PHANDLE", "FileHandle"}, {"ULONG", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"ULONG", "CreateOptions"}, {"ULONG", "MailslotQuota"}, {"ULONG", "MaximumMessageSize"}, {"PLARGE_INTEGER", "ReadTimeout"}}},
        {"_ZwCreateMutant@16", 4, {{"PHANDLE", "MutantHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"BOOLEAN", "InitialOwner"}}},
        {"_ZwCreateNamedPipeFile@56", 14, {{"PHANDLE", "FileHandle"}, {"ULONG", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"ULONG", "ShareAccess"}, {"ULONG", "CreateDisposition"}, {"ULONG", "CreateOptions"}, {"ULONG", "NamedPipeType"}, {"ULONG", "ReadMode"}, {"ULONG", "CompletionMode"}, {"ULONG", "MaximumInstances"}, {"ULONG", "InboundQuota"}, {"ULONG", "OutboundQuota"}, {"PLARGE_INTEGER", "DefaultTimeout"}}},
        {"_NtCreatePagingFile@16", 4, {{"PUNICODE_STRING", "PageFileName"}, {"PLARGE_INTEGER", "MinimumSize"}, {"PLARGE_INTEGER", "MaximumSize"}, {"ULONG", "Priority"}}},
        {"_ZwCreatePort@20", 5, {{"PHANDLE", "PortHandle"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"ULONG", "MaxConnectionInfoLength"}, {"ULONG", "MaxMessageLength"}, {"ULONG", "MaxPoolUsage"}}},
        {"_NtCreatePrivateNamespace@16", 4, {{"PHANDLE", "NamespaceHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PVOID", "BoundaryDescriptor"}}},
        {"_ZwCreateProcessEx@36", 9, {{"PHANDLE", "ProcessHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"HANDLE", "ParentProcess"}, {"ULONG", "Flags"}, {"HANDLE", "SectionHandle"}, {"HANDLE", "DebugPort"}, {"HANDLE", "ExceptionPort"}, {"ULONG", "JobMemberLevel"}}},
        {"_ZwCreateProcess@32", 8, {{"PHANDLE", "ProcessHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"HANDLE", "ParentProcess"}, {"BOOLEAN", "InheritObjectTable"}, {"HANDLE", "SectionHandle"}, {"HANDLE", "DebugPort"}, {"HANDLE", "ExceptionPort"}}},
        {"_NtCreateProfileEx@40", 10, {{"PHANDLE", "ProfileHandle"}, {"HANDLE", "Process"}, {"PVOID", "ProfileBase"}, {"SIZE_T", "ProfileSize"}, {"ULONG", "BucketSize"}, {"PULONG", "Buffer"}, {"ULONG", "BufferSize"}, {"KPROFILE_SOURCE", "ProfileSource"}, {"ULONG", "GroupAffinityCount"}, {"PGROUP_AFFINITY", "GroupAffinity"}}},
        {"_ZwCreateProfile@36", 9, {{"PHANDLE", "ProfileHandle"}, {"HANDLE", "Process"}, {"PVOID", "RangeBase"}, {"SIZE_T", "RangeSize"}, {"ULONG", "BucketSize"}, {"PULONG", "Buffer"}, {"ULONG", "BufferSize"}, {"KPROFILE_SOURCE", "ProfileSource"}, {"KAFFINITY", "Affinity"}}},
        {"_ZwCreateResourceManager@28", 7, {{"PHANDLE", "ResourceManagerHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"HANDLE", "TmHandle"}, {"LPGUID", "RmGuid"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"ULONG", "CreateOptions"}, {"PUNICODE_STRING", "Description"}}},
        {"_NtCreateSection@28", 7, {{"PHANDLE", "SectionHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PLARGE_INTEGER", "MaximumSize"}, {"ULONG", "SectionPageProtection"}, {"ULONG", "AllocationAttributes"}, {"HANDLE", "FileHandle"}}},
        {"_NtCreateSemaphore@20", 5, {{"PHANDLE", "SemaphoreHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"LONG", "InitialCount"}, {"LONG", "MaximumCount"}}},
        {"_ZwCreateSymbolicLinkObject@16", 4, {{"PHANDLE", "LinkHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PUNICODE_STRING", "LinkTarget"}}},
        {"_NtCreateThreadEx@44", 11, {{"PHANDLE", "ThreadHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"HANDLE", "ProcessHandle"}, {"PVOID", "StartRoutine"}, {"PVOID", "Argument"}, {"ULONG", "CreateFlags"}, {"ULONG_PTR", "ZeroBits"}, {"SIZE_T", "StackSize"}, {"SIZE_T", "MaximumStackSize"}, {"PPS_ATTRIBUTE_LIST", "AttributeList"}}},
        {"_NtCreateThread@32", 8, {{"PHANDLE", "ThreadHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"HANDLE", "ProcessHandle"}, {"PCLIENT_ID", "ClientId"}, {"PCONTEXT", "ThreadContext"}, {"PINITIAL_TEB", "InitialTeb"}, {"BOOLEAN", "CreateSuspended"}}},
        {"_ZwCreateTimer@16", 4, {{"PHANDLE", "TimerHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"TIMER_TYPE", "TimerType"}}},
        {"_NtCreateToken@52", 13, {{"PHANDLE", "TokenHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"TOKEN_TYPE", "TokenType"}, {"PLUID", "AuthenticationId"}, {"PLARGE_INTEGER", "ExpirationTime"}, {"PTOKEN_USER", "User"}, {"PTOKEN_GROUPS", "Groups"}, {"PTOKEN_PRIVILEGES", "Privileges"}, {"PTOKEN_OWNER", "Owner"}, {"PTOKEN_PRIMARY_GROUP", "PrimaryGroup"}, {"PTOKEN_DEFAULT_DACL", "DefaultDacl"}, {"PTOKEN_SOURCE", "TokenSource"}}},
        {"_ZwCreateTransactionManager@24", 6, {{"PHANDLE", "TmHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PUNICODE_STRING", "LogFileName"}, {"ULONG", "CreateOptions"}, {"ULONG", "CommitStrength"}}},
        {"_NtCreateTransaction@40", 10, {{"PHANDLE", "TransactionHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"LPGUID", "Uow"}, {"HANDLE", "TmHandle"}, {"ULONG", "CreateOptions"}, {"ULONG", "IsolationLevel"}, {"ULONG", "IsolationFlags"}, {"PLARGE_INTEGER", "Timeout"}, {"PUNICODE_STRING", "Description"}}},
        {"_NtCreateUserProcess@44", 11, {{"PHANDLE", "ProcessHandle"}, {"PHANDLE", "ThreadHandle"}, {"ACCESS_MASK", "ProcessDesiredAccess"}, {"ACCESS_MASK", "ThreadDesiredAccess"}, {"POBJECT_ATTRIBUTES", "ProcessObjectAttributes"}, {"POBJECT_ATTRIBUTES", "ThreadObjectAttributes"}, {"ULONG", "ProcessFlags"}, {"ULONG", "ThreadFlags"}, {"PRTL_USER_PROCESS_PARAMETERS", "ProcessParameters"}, {"PPROCESS_CREATE_INFO", "CreateInfo"}, {"PPROCESS_ATTRIBUTE_LIST", "AttributeList"}}},
        {"_ZwCreateWaitablePort@20", 5, {{"PHANDLE", "PortHandle"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"ULONG", "MaxConnectionInfoLength"}, {"ULONG", "MaxMessageLength"}, {"ULONG", "MaxPoolUsage"}}},
        {"_NtCreateWorkerFactory@40", 10, {{"PHANDLE", "WorkerFactoryHandleReturn"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"HANDLE", "CompletionPortHandle"}, {"HANDLE", "WorkerProcessHandle"}, {"PVOID", "StartRoutine"}, {"PVOID", "StartParameter"}, {"ULONG", "MaxThreadCount"}, {"SIZE_T", "StackReserve"}, {"SIZE_T", "StackCommit"}}},
        {"_NtDebugActiveProcess@8", 2, {{"HANDLE", "ProcessHandle"}, {"HANDLE", "DebugObjectHandle"}}},
        {"_ZwDebugContinue@12", 3, {{"HANDLE", "DebugObjectHandle"}, {"PCLIENT_ID", "ClientId"}, {"NTSTATUS", "ContinueStatus"}}},
        {"_ZwDelayExecution@8", 2, {{"BOOLEAN", "Alertable"}, {"PLARGE_INTEGER", "DelayInterval"}}},
        {"_ZwDeleteAtom@4", 1, {{"RTL_ATOM", "Atom"}}},
        {"_NtDeleteBootEntry@4", 1, {{"ULONG", "Id"}}},
        {"_ZwDeleteDriverEntry@4", 1, {{"ULONG", "Id"}}},
        {"_NtDeleteFile@4", 1, {{"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_ZwDeleteKey@4", 1, {{"HANDLE", "KeyHandle"}}},
        {"_NtDeleteObjectAuditAlarm@12", 3, {{"PUNICODE_STRING", "SubsystemName"}, {"PVOID", "HandleId"}, {"BOOLEAN", "GenerateOnClose"}}},
        {"_NtDeletePrivateNamespace@4", 1, {{"HANDLE", "NamespaceHandle"}}},
        {"_NtDeleteValueKey@8", 2, {{"HANDLE", "KeyHandle"}, {"PUNICODE_STRING", "ValueName"}}},
        {"_ZwDeviceIoControlFile@40", 10, {{"HANDLE", "FileHandle"}, {"HANDLE", "Event"}, {"PIO_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcContext"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"ULONG", "IoControlCode"}, {"PVOID", "InputBuffer"}, {"ULONG", "InputBufferLength"}, {"PVOID", "OutputBuffer"}, {"ULONG", "OutputBufferLength"}}},
        {"_NtDisplayString@4", 1, {{"PUNICODE_STRING", "String"}}},
        {"_ZwDrawText@4", 1, {{"PUNICODE_STRING", "Text"}}},
        {"_ZwDuplicateObject@28", 7, {{"HANDLE", "SourceProcessHandle"}, {"HANDLE", "SourceHandle"}, {"HANDLE", "TargetProcessHandle"}, {"PHANDLE", "TargetHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"ULONG", "HandleAttributes"}, {"ULONG", "Options"}}},
        {"_NtDuplicateToken@24", 6, {{"HANDLE", "ExistingTokenHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"BOOLEAN", "EffectiveOnly"}, {"TOKEN_TYPE", "TokenType"}, {"PHANDLE", "NewTokenHandle"}}},
        {"_ZwEnumerateBootEntries@8", 2, {{"PVOID", "Buffer"}, {"PULONG", "BufferLength"}}},
        {"_NtEnumerateDriverEntries@8", 2, {{"PVOID", "Buffer"}, {"PULONG", "BufferLength"}}},
        {"_ZwEnumerateKey@24", 6, {{"HANDLE", "KeyHandle"}, {"ULONG", "Index"}, {"KEY_INFORMATION_CLASS", "KeyInformationClass"}, {"PVOID", "KeyInformation"}, {"ULONG", "Length"}, {"PULONG", "ResultLength"}}},
        {"_ZwEnumerateSystemEnvironmentValuesEx@12", 3, {{"ULONG", "InformationClass"}, {"PVOID", "Buffer"}, {"PULONG", "BufferLength"}}},
        {"_ZwEnumerateTransactionObject@20", 5, {{"HANDLE", "RootObjectHandle"}, {"KTMOBJECT_TYPE", "QueryType"}, {"PKTMOBJECT_CURSOR", "ObjectCursor"}, {"ULONG", "ObjectCursorLength"}, {"PULONG", "ReturnLength"}}},
        {"_NtEnumerateValueKey@24", 6, {{"HANDLE", "KeyHandle"}, {"ULONG", "Index"}, {"KEY_VALUE_INFORMATION_CLASS", "KeyValueInformationClass"}, {"PVOID", "KeyValueInformation"}, {"ULONG", "Length"}, {"PULONG", "ResultLength"}}},
        {"_ZwExtendSection@8", 2, {{"HANDLE", "SectionHandle"}, {"PLARGE_INTEGER", "NewSectionSize"}}},
        {"_NtFilterToken@24", 6, {{"HANDLE", "ExistingTokenHandle"}, {"ULONG", "Flags"}, {"PTOKEN_GROUPS", "SidsToDisable"}, {"PTOKEN_PRIVILEGES", "PrivilegesToDelete"}, {"PTOKEN_GROUPS", "RestrictedSids"}, {"PHANDLE", "NewTokenHandle"}}},
        {"_NtFindAtom@12", 3, {{"PWSTR", "AtomName"}, {"ULONG", "Length"}, {"PRTL_ATOM", "Atom"}}},
        {"_ZwFlushBuffersFile@8", 2, {{"HANDLE", "FileHandle"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}}},
        {"_ZwFlushInstallUILanguage@8", 2, {{"LANGID", "InstallUILanguage"}, {"ULONG", "SetComittedFlag"}}},
        {"_ZwFlushInstructionCache@12", 3, {{"HANDLE", "ProcessHandle"}, {"PVOID", "BaseAddress"}, {"SIZE_T", "Length"}}},
        {"_NtFlushKey@4", 1, {{"HANDLE", "KeyHandle"}}},
        {"_ZwFlushVirtualMemory@16", 4, {{"HANDLE", "ProcessHandle"}, {"PVOID", "STARBaseAddress"}, {"PSIZE_T", "RegionSize"}, {"PIO_STATUS_BLOCK", "IoStatus"}}},
        {"_NtFreeUserPhysicalPages@12", 3, {{"HANDLE", "ProcessHandle"}, {"PULONG_PTR", "NumberOfPages"}, {"PULONG_PTR", "UserPfnArra"}}},
        {"_NtFreeVirtualMemory@16", 4, {{"HANDLE", "ProcessHandle"}, {"PVOID", "STARBaseAddress"}, {"PSIZE_T", "RegionSize"}, {"ULONG", "FreeType"}}},
        {"_NtFreezeRegistry@4", 1, {{"ULONG", "TimeOutInSeconds"}}},
        {"_ZwFreezeTransactions@8", 2, {{"PLARGE_INTEGER", "FreezeTimeout"}, {"PLARGE_INTEGER", "ThawTimeout"}}},
        {"_NtFsControlFile@40", 10, {{"HANDLE", "FileHandle"}, {"HANDLE", "Event"}, {"PIO_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcContext"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"ULONG", "IoControlCode"}, {"PVOID", "InputBuffer"}, {"ULONG", "InputBufferLength"}, {"PVOID", "OutputBuffer"}, {"ULONG", "OutputBufferLength"}}},
        {"_NtGetContextThread@8", 2, {{"HANDLE", "ThreadHandle"}, {"PCONTEXT", "ThreadContext"}}},
        {"_NtGetDevicePowerState@8", 2, {{"HANDLE", "Device"}, {"DEVICE_POWER_STATE", "STARState"}}},
        {"_NtGetMUIRegistryInfo@12", 3, {{"ULONG", "Flags"}, {"PULONG", "DataSize"}, {"PVOID", "Data"}}},
        {"_ZwGetNextProcess@20", 5, {{"HANDLE", "ProcessHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"ULONG", "HandleAttributes"}, {"ULONG", "Flags"}, {"PHANDLE", "NewProcessHandle"}}},
        {"_ZwGetNextThread@24", 6, {{"HANDLE", "ProcessHandle"}, {"HANDLE", "ThreadHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"ULONG", "HandleAttributes"}, {"ULONG", "Flags"}, {"PHANDLE", "NewThreadHandle"}}},
        {"_NtGetNlsSectionPtr@20", 5, {{"ULONG", "SectionType"}, {"ULONG", "SectionData"}, {"PVOID", "ContextData"}, {"PVOID", "STARSectionPointer"}, {"PULONG", "SectionSize"}}},
        {"_ZwGetNotificationResourceManager@28", 7, {{"HANDLE", "ResourceManagerHandle"}, {"PTRANSACTION_NOTIFICATION", "TransactionNotification"}, {"ULONG", "NotificationLength"}, {"PLARGE_INTEGER", "Timeout"}, {"PULONG", "ReturnLength"}, {"ULONG", "Asynchronous"}, {"ULONG_PTR", "AsynchronousContext"}}},
        {"_NtGetWriteWatch@28", 7, {{"HANDLE", "ProcessHandle"}, {"ULONG", "Flags"}, {"PVOID", "BaseAddress"}, {"SIZE_T", "RegionSize"}, {"PVOID", "STARUserAddressArray"}, {"PULONG_PTR", "EntriesInUserAddressArray"}, {"PULONG", "Granularity"}}},
        {"_NtImpersonateAnonymousToken@4", 1, {{"HANDLE", "ThreadHandle"}}},
        {"_ZwImpersonateClientOfPort@8", 2, {{"HANDLE", "PortHandle"}, {"PPORT_MESSAGE", "Message"}}},
        {"_ZwImpersonateThread@12", 3, {{"HANDLE", "ServerThreadHandle"}, {"HANDLE", "ClientThreadHandle"}, {"PSECURITY_QUALITY_OF_SERVICE", "SecurityQos"}}},
        {"_NtInitializeNlsFiles@12", 3, {{"PVOID", "STARBaseAddress"}, {"PLCID", "DefaultLocaleId"}, {"PLARGE_INTEGER", "DefaultCasingTableSize"}}},
        {"_ZwInitializeRegistry@4", 1, {{"USHORT", "BootCondition"}}},
        {"_NtInitiatePowerAction@16", 4, {{"POWER_ACTION", "SystemAction"}, {"SYSTEM_POWER_STATE", "MinSystemState"}, {"ULONG", "Flags"}, {"BOOLEAN", "Asynchronous"}}},
        {"_ZwIsProcessInJob@8", 2, {{"HANDLE", "ProcessHandle"}, {"HANDLE", "JobHandle"}}},
        {"_ZwListenPort@8", 2, {{"HANDLE", "PortHandle"}, {"PPORT_MESSAGE", "ConnectionRequest"}}},
        {"_NtLoadDriver@4", 1, {{"PUNICODE_STRING", "DriverServiceName"}}},
        {"_NtLoadKey2@12", 3, {{"POBJECT_ATTRIBUTES", "TargetKey"}, {"POBJECT_ATTRIBUTES", "SourceFile"}, {"ULONG", "Flags"}}},
        {"_NtLoadKeyEx@32", 8, {{"POBJECT_ATTRIBUTES", "TargetKey"}, {"POBJECT_ATTRIBUTES", "SourceFile"}, {"ULONG", "Flags"}, {"HANDLE", "TrustClassKey"}, {"PVOID", "Reserved"}, {"PVOID", "ObjectContext"}, {"PVOID", "CallbackReserverd"}, {"PVOID", "IoStatusBlock"}}},
        {"_NtLoadKey@8", 2, {{"POBJECT_ATTRIBUTES", "TargetKey"}, {"POBJECT_ATTRIBUTES", "SourceFile"}}},
        {"_NtLockFile@40", 10, {{"HANDLE", "FileHandle"}, {"HANDLE", "Event"}, {"PIO_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcContext"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PLARGE_INTEGER", "ByteOffset"}, {"PLARGE_INTEGER", "Length"}, {"ULONG", "Key"}, {"BOOLEAN", "FailImmediately"}, {"BOOLEAN", "ExclusiveLock"}}},
        {"_ZwLockProductActivationKeys@8", 2, {{"ULONG", "STARpPrivateVer"}, {"ULONG", "STARpSafeMode"}}},
        {"_NtLockRegistryKey@4", 1, {{"HANDLE", "KeyHandle"}}},
        {"_ZwLockVirtualMemory@16", 4, {{"HANDLE", "ProcessHandle"}, {"PVOID", "STARBaseAddress"}, {"PSIZE_T", "RegionSize"}, {"ULONG", "MapType"}}},
        {"_ZwMakePermanentObject@4", 1, {{"HANDLE", "Handle"}}},
        {"_NtMakeTemporaryObject@4", 1, {{"HANDLE", "Handle"}}},
        {"_ZwMapCMFModule@24", 6, {{"ULONG", "What"}, {"ULONG", "Index"}, {"PULONG", "CacheIndexOut"}, {"PULONG", "CacheFlagsOut"}, {"PULONG", "ViewSizeOut"}, {"PVOID", "STARBaseAddress"}}},
        {"_NtMapUserPhysicalPages@12", 3, {{"PVOID", "VirtualAddress"}, {"ULONG_PTR", "NumberOfPages"}, {"PULONG_PTR", "UserPfnArra"}}},
        {"_ZwMapUserPhysicalPagesScatter@12", 3, {{"PVOID", "STARVirtualAddresses"}, {"ULONG_PTR", "NumberOfPages"}, {"PULONG_PTR", "UserPfnArray"}}},
        {"_ZwMapViewOfSection@40", 10, {{"HANDLE", "SectionHandle"}, {"HANDLE", "ProcessHandle"}, {"PVOID", "STARBaseAddress"}, {"ULONG_PTR", "ZeroBits"}, {"SIZE_T", "CommitSize"}, {"PLARGE_INTEGER", "SectionOffset"}, {"PSIZE_T", "ViewSize"}, {"SECTION_INHERIT", "InheritDisposition"}, {"ULONG", "AllocationType"}, {"WIN32_PROTECTION_MASK", "Win32Protect"}}},
        {"_NtModifyBootEntry@4", 1, {{"PBOOT_ENTRY", "BootEntry"}}},
        {"_ZwModifyDriverEntry@4", 1, {{"PEFI_DRIVER_ENTRY", "DriverEntry"}}},
        {"_NtNotifyChangeDirectoryFile@36", 9, {{"HANDLE", "FileHandle"}, {"HANDLE", "Event"}, {"PIO_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcContext"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PVOID", "Buffer"}, {"ULONG", "Length"}, {"ULONG", "CompletionFilter"}, {"BOOLEAN", "WatchTree"}}},
        {"_NtNotifyChangeKey@40", 10, {{"HANDLE", "KeyHandle"}, {"HANDLE", "Event"}, {"PIO_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcContext"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"ULONG", "CompletionFilter"}, {"BOOLEAN", "WatchTree"}, {"PVOID", "Buffer"}, {"ULONG", "BufferSize"}, {"BOOLEAN", "Asynchronous"}}},
        {"_NtNotifyChangeMultipleKeys@48", 12, {{"HANDLE", "MasterKeyHandle"}, {"ULONG", "Count"}, {"POBJECT_ATTRIBUTES", "SlaveObjects"}, {"HANDLE", "Event"}, {"PIO_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcContext"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"ULONG", "CompletionFilter"}, {"BOOLEAN", "WatchTree"}, {"PVOID", "Buffer"}, {"ULONG", "BufferSize"}, {"BOOLEAN", "Asynchronous"}}},
        {"_NtNotifyChangeSession@32", 8, {{"HANDLE", "Session"}, {"ULONG", "IoStateSequence"}, {"PVOID", "Reserved"}, {"ULONG", "Action"}, {"IO_SESSION_STATE", "IoState"}, {"IO_SESSION_STATE", "IoState2"}, {"PVOID", "Buffer"}, {"ULONG", "BufferSize"}}},
        {"_ZwOpenDirectoryObject@12", 3, {{"PHANDLE", "DirectoryHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_ZwOpenEnlistment@20", 5, {{"PHANDLE", "EnlistmentHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"HANDLE", "ResourceManagerHandle"}, {"LPGUID", "EnlistmentGuid"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_NtOpenEvent@12", 3, {{"PHANDLE", "EventHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_NtOpenEventPair@12", 3, {{"PHANDLE", "EventPairHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_NtOpenFile@24", 6, {{"PHANDLE", "FileHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"ULONG", "ShareAccess"}, {"ULONG", "OpenOptions"}}},
        {"_ZwOpenIoCompletion@12", 3, {{"PHANDLE", "IoCompletionHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_ZwOpenJobObject@12", 3, {{"PHANDLE", "JobHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_NtOpenKeyedEvent@12", 3, {{"PHANDLE", "KeyedEventHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_ZwOpenKeyEx@16", 4, {{"PHANDLE", "KeyHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"ULONG", "OpenOptions"}}},
        {"_ZwOpenKey@12", 3, {{"PHANDLE", "KeyHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_NtOpenKeyTransactedEx@20", 5, {{"PHANDLE", "KeyHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"ULONG", "OpenOptions"}, {"HANDLE", "TransactionHandle"}}},
        {"_NtOpenKeyTransacted@16", 4, {{"PHANDLE", "KeyHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"HANDLE", "TransactionHandle"}}},
        {"_NtOpenMutant@12", 3, {{"PHANDLE", "MutantHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        ...
        {"_NtOpenPrivateNamespace@16", 4, {{"PHANDLE", "NamespaceHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PVOID", "BoundaryDescriptor"}}},
        {"_ZwOpenProcess@16", 4, {{"PHANDLE", "ProcessHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PCLIENT_ID", "ClientId"}}},
        {"_ZwOpenProcessTokenEx@16", 4, {{"HANDLE", "ProcessHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"ULONG", "HandleAttributes"}, {"PHANDLE", "TokenHandle"}}},
        {"_ZwOpenProcessToken@12", 3, {{"HANDLE", "ProcessHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"PHANDLE", "TokenHandle"}}},
        {"_ZwOpenResourceManager@20", 5, {{"PHANDLE", "ResourceManagerHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"HANDLE", "TmHandle"}, {"LPGUID", "ResourceManagerGuid"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_NtOpenSection@12", 3, {{"PHANDLE", "SectionHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_NtOpenSemaphore@12", 3, {{"PHANDLE", "SemaphoreHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_NtOpenSession@12", 3, {{"PHANDLE", "SessionHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_NtOpenSymbolicLinkObject@12", 3, {{"PHANDLE", "LinkHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_ZwOpenThread@16", 4, {{"PHANDLE", "ThreadHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PCLIENT_ID", "ClientId"}}},
        {"_NtOpenThreadTokenEx@20", 5, {{"HANDLE", "ThreadHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"BOOLEAN", "OpenAsSelf"}, {"ULONG", "HandleAttributes"}, {"PHANDLE", "TokenHandle"}}},
        {"_NtOpenThreadToken@16", 4, {{"HANDLE", "ThreadHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"BOOLEAN", "OpenAsSelf"}, {"PHANDLE", "TokenHandle"}}},
        {"_ZwOpenTimer@12", 3, {{"PHANDLE", "TimerHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}}},
        {"_ZwOpenTransactionManager@24", 6, {{"PHANDLE", "TmHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PUNICODE_STRING", "LogFileName"}, {"LPGUID", "TmIdentity"}, {"ULONG", "OpenOptions"}}},
        {"_ZwOpenTransaction@20", 5, {{"PHANDLE", "TransactionHandle"}, {"ACCESS_MASK", "DesiredAccess"}, {"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"LPGUID", "Uow"}, {"HANDLE", "TmHandle"}}},
        {"_NtPlugPlayControl@12", 3, {{"PLUGPLAY_CONTROL_CLASS", "PnPControlClass"}, {"PVOID", "PnPControlData"}, {"ULONG", "PnPControlDataLength"}}},
        {"_ZwPowerInformation@20", 5, {{"POWER_INFORMATION_LEVEL", "InformationLevel"}, {"PVOID", "InputBuffer"}, {"ULONG", "InputBufferLength"}, {"PVOID", "OutputBuffer"}, {"ULONG", "OutputBufferLength"}}},
        {"_NtPrepareComplete@8", 2, {{"HANDLE", "EnlistmentHandle"}, {"PLARGE_INTEGER", "TmVirtualClock"}}},
        {"_ZwPrepareEnlistment@8", 2, {{"HANDLE", "EnlistmentHandle"}, {"PLARGE_INTEGER", "TmVirtualClock"}}},
        {"_ZwPrePrepareComplete@8", 2, {{"HANDLE", "EnlistmentHandle"}, {"PLARGE_INTEGER", "TmVirtualClock"}}},
        {"_NtPrePrepareEnlistment@8", 2, {{"HANDLE", "EnlistmentHandle"}, {"PLARGE_INTEGER", "TmVirtualClock"}}},
        {"_ZwPrivilegeCheck@12", 3, {{"HANDLE", "ClientToken"}, {"PPRIVILEGE_SET", "RequiredPrivileges"}, {"PBOOLEAN", "Result"}}},
        {"_NtPrivilegedServiceAuditAlarm@20", 5, {{"PUNICODE_STRING", "SubsystemName"}, {"PUNICODE_STRING", "ServiceName"}, {"HANDLE", "ClientToken"}, {"PPRIVILEGE_SET", "Privileges"}, {"BOOLEAN", "AccessGranted"}}},
        {"_ZwPrivilegeObjectAuditAlarm@24", 6, {{"PUNICODE_STRING", "SubsystemName"}, {"PVOID", "HandleId"}, {"HANDLE", "ClientToken"}, {"ACCESS_MASK", "DesiredAccess"}, {"PPRIVILEGE_SET", "Privileges"}, {"BOOLEAN", "AccessGranted"}}},
        {"_NtPropagationComplete@16", 4, {{"HANDLE", "ResourceManagerHandle"}, {"ULONG", "RequestCookie"}, {"ULONG", "BufferLength"}, {"PVOID", "Buffer"}}},
        {"_ZwPropagationFailed@12", 3, {{"HANDLE", "ResourceManagerHandle"}, {"ULONG", "RequestCookie"}, {"NTSTATUS", "PropStatus"}}},
        {"_ZwProtectVirtualMemory@20", 5, {{"HANDLE", "ProcessHandle"}, {"PVOID", "STARBaseAddress"}, {"PSIZE_T", "RegionSize"}, {"WIN32_PROTECTION_MASK", "NewProtectWin32"}, {"PULONG", "OldProtect"}}},
        {"_ZwPulseEvent@8", 2, {{"HANDLE", "EventHandle"}, {"PLONG", "PreviousState"}}},
        {"_ZwQueryAttributesFile@8", 2, {{"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PFILE_BASIC_INFORMATION", "FileInformation"}}},
        {"_ZwQueryBootEntryOrder@8", 2, {{"PULONG", "Ids"}, {"PULONG", "Count"}}},
        {"_ZwQueryBootOptions@8", 2, {{"PBOOT_OPTIONS", "BootOptions"}, {"PULONG", "BootOptionsLength"}}},
        {"_NtQueryDebugFilterState@8", 2, {{"ULONG", "ComponentId"}, {"ULONG", "Level"}}},
        {"_NtQueryDefaultLocale@8", 2, {{"BOOLEAN", "UserProfile"}, {"PLCID", "DefaultLocaleId"}}},
        {"_ZwQueryDefaultUILanguage@4", 1, {{"LANGID", "STARDefaultUILanguageId"}}},
        {"_ZwQueryDirectoryFile@44", 11, {{"HANDLE", "FileHandle"}, {"HANDLE", "Event"}, {"PIO_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcContext"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PVOID", "FileInformation"}, {"ULONG", "Length"}, {"FILE_INFORMATION_CLASS", "FileInformationClass"}, {"BOOLEAN", "ReturnSingleEntry"}, {"PUNICODE_STRING", "FileName"}, {"BOOLEAN", "RestartScan"}}},
        {"_ZwQueryDirectoryObject@28", 7, {{"HANDLE", "DirectoryHandle"}, {"PVOID", "Buffer"}, {"ULONG", "Length"}, {"BOOLEAN", "ReturnSingleEntry"}, {"BOOLEAN", "RestartScan"}, {"PULONG", "Context"}, {"PULONG", "ReturnLength"}}},
        {"_NtQueryDriverEntryOrder@8", 2, {{"PULONG", "Ids"}, {"PULONG", "Count"}}},
        {"_ZwQueryEaFile@36", 9, {{"HANDLE", "FileHandle"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PVOID", "Buffer"}, {"ULONG", "Length"}, {"BOOLEAN", "ReturnSingleEntry"}, {"PVOID", "EaList"}, {"ULONG", "EaListLength"}, {"PULONG", "EaIndex"}, {"BOOLEAN", "RestartScan"}}},
        {"_NtQueryEvent@20", 5, {{"HANDLE", "EventHandle"}, {"EVENT_INFORMATION_CLASS", "EventInformationClass"}, {"PVOID", "EventInformation"}, {"ULONG", "EventInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_ZwQueryFullAttributesFile@8", 2, {{"POBJECT_ATTRIBUTES", "ObjectAttributes"}, {"PFILE_NETWORK_OPEN_INFORMATION", "FileInformation"}}},
        {"_NtQueryInformationAtom@20", 5, {{"RTL_ATOM", "Atom"}, {"ATOM_INFORMATION_CLASS", "InformationClass"}, {"PVOID", "AtomInformation"}, {"ULONG", "AtomInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_ZwQueryInformationEnlistment@20", 5, {{"HANDLE", "EnlistmentHandle"}, {"ENLISTMENT_INFORMATION_CLASS", "EnlistmentInformationClass"}, {"PVOID", "EnlistmentInformation"}, {"ULONG", "EnlistmentInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_ZwQueryInformationFile@20", 5, {{"HANDLE", "FileHandle"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PVOID", "FileInformation"}, {"ULONG", "Length"}, {"FILE_INFORMATION_CLASS", "FileInformationClass"}}},
        {"_ZwQueryInformationJobObject@20", 5, {{"HANDLE", "JobHandle"}, {"JOBOBJECTINFOCLASS", "JobObjectInformationClass"}, {"PVOID", "JobObjectInformation"}, {"ULONG", "JobObjectInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_ZwQueryInformationPort@20", 5, {{"HANDLE", "PortHandle"}, {"PORT_INFORMATION_CLASS", "PortInformationClass"}, {"PVOID", "PortInformation"}, {"ULONG", "Length"}, {"PULONG", "ReturnLength"}}},
        {"_ZwQueryInformationProcess@20", 5, {{"HANDLE", "ProcessHandle"}, {"PROCESSINFOCLASS", "ProcessInformationClass"}, {"PVOID", "ProcessInformation"}, {"ULONG", "ProcessInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_ZwQueryInformationResourceManager@20", 5, {{"HANDLE", "ResourceManagerHandle"}, {"RESOURCEMANAGER_INFORMATION_CLASS", "ResourceManagerInformationClass"}, {"PVOID", "ResourceManagerInformation"}, {"ULONG", "ResourceManagerInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_NtQueryInformationThread@20", 5, {{"HANDLE", "ThreadHandle"}, {"THREADINFOCLASS", "ThreadInformationClass"}, {"PVOID", "ThreadInformation"}, {"ULONG", "ThreadInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_ZwQueryInformationToken@20", 5, {{"HANDLE", "TokenHandle"}, {"TOKEN_INFORMATION_CLASS", "TokenInformationClass"}, {"PVOID", "TokenInformation"}, {"ULONG", "TokenInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_ZwQueryInformationTransaction@20", 5, {{"HANDLE", "TransactionHandle"}, {"TRANSACTION_INFORMATION_CLASS", "TransactionInformationClass"}, {"PVOID", "TransactionInformation"}, {"ULONG", "TransactionInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_NtQueryInformationTransactionManager@20", 5, {{"HANDLE", "TransactionManagerHandle"}, {"TRANSACTIONMANAGER_INFORMATION_CLASS", "TransactionManagerInformationClass"}, {"PVOID", "TransactionManagerInformation"}, {"ULONG", "TransactionManagerInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_ZwQueryInformationWorkerFactory@20", 5, {{"HANDLE", "WorkerFactoryHandle"}, {"WORKERFACTORYINFOCLASS", "WorkerFactoryInformationClass"}, {"PVOID", "WorkerFactoryInformation"}, {"ULONG", "WorkerFactoryInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_NtQueryInstallUILanguage@4", 1, {{"LANGID", "STARInstallUILanguageId"}}},
        {"_NtQueryIntervalProfile@8", 2, {{"KPROFILE_SOURCE", "ProfileSource"}, {"PULONG", "Interval"}}},
        {"_NtQueryIoCompletion@20", 5, {{"HANDLE", "IoCompletionHandle"}, {"IO_COMPLETION_INFORMATION_CLASS", "IoCompletionInformationClass"}, {"PVOID", "IoCompletionInformation"}, {"ULONG", "IoCompletionInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_ZwQueryKey@20", 5, {{"HANDLE", "KeyHandle"}, {"KEY_INFORMATION_CLASS", "KeyInformationClass"}, {"PVOID", "KeyInformation"}, {"ULONG", "Length"}, {"PULONG", "ResultLength"}}},
        {"_NtQueryLicenseValue@20", 5, {{"PUNICODE_STRING", "Name"}, {"PULONG", "Type"}, {"PVOID", "Buffer"}, {"ULONG", "Length"}, {"PULONG", "ReturnedLength"}}},
        {"_NtQueryMultipleValueKey@24", 6, {{"HANDLE", "KeyHandle"}, {"PKEY_VALUE_ENTRY", "ValueEntries"}, {"ULONG", "EntryCount"}, {"PVOID", "ValueBuffer"}, {"PULONG", "BufferLength"}, {"PULONG", "RequiredBufferLength"}}},
        {"_NtQueryMutant@20", 5, {{"HANDLE", "MutantHandle"}, {"MUTANT_INFORMATION_CLASS", "MutantInformationClass"}, {"PVOID", "MutantInformation"}, {"ULONG", "MutantInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_NtQueryObject@20", 5, {{"HANDLE", "Handle"}, {"OBJECT_INFORMATION_CLASS", "ObjectInformationClass"}, {"PVOID", "ObjectInformation"}, {"ULONG", "ObjectInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_NtQueryOpenSubKeysEx@16", 4, {{"POBJECT_ATTRIBUTES", "TargetKey"}, {"ULONG", "BufferLength"}, {"PVOID", "Buffer"}, {"PULONG", "RequiredSize"}}},
        {"_NtQueryOpenSubKeys@8", 2, {{"POBJECT_ATTRIBUTES", "TargetKey"}, {"PULONG", "HandleCount"}}},
        {"_NtQueryPerformanceCounter@8", 2, {{"PLARGE_INTEGER", "PerformanceCounter"}, {"PLARGE_INTEGER", "PerformanceFrequency"}}},
        {"_ZwQueryQuotaInformationFile@36", 9, {{"HANDLE", "FileHandle"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PVOID", "Buffer"}, {"ULONG", "Length"}, {"BOOLEAN", "ReturnSingleEntry"}, {"PVOID", "SidList"}, {"ULONG", "SidListLength"}, {"PULONG", "StartSid"}, {"BOOLEAN", "RestartScan"}}},
        {"_ZwQuerySection@20", 5, {{"HANDLE", "SectionHandle"}, {"SECTION_INFORMATION_CLASS", "SectionInformationClass"}, {"PVOID", "SectionInformation"}, {"SIZE_T", "SectionInformationLength"}, {"PSIZE_T", "ReturnLength"}}},
        {"_ZwQuerySecurityAttributesToken@24", 6, {{"HANDLE", "TokenHandle"}, {"PUNICODE_STRING", "Attributes"}, {"ULONG", "NumberOfAttributes"}, {"PVOID", "Buffer"}, {"ULONG", "Length"}, {"PULONG", "ReturnLength"}}},
        {"_NtQuerySecurityObject@20", 5, {{"HANDLE", "Handle"}, {"SECURITY_INFORMATION", "SecurityInformation"}, {"PSECURITY_DESCRIPTOR", "SecurityDescriptor"}, {"ULONG", "Length"}, {"PULONG", "LengthNeeded"}}},
        {"_ZwQuerySemaphore@20", 5, {{"HANDLE", "SemaphoreHandle"}, {"SEMAPHORE_INFORMATION_CLASS", "SemaphoreInformationClass"}, {"PVOID", "SemaphoreInformation"}, {"ULONG", "SemaphoreInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_ZwQuerySymbolicLinkObject@12", 3, {{"HANDLE", "LinkHandle"}, {"PUNICODE_STRING", "LinkTarget"}, {"PULONG", "ReturnedLength"}}},
        {"_ZwQuerySystemEnvironmentValueEx@20", 5, {{"PUNICODE_STRING", "VariableName"}, {"LPGUID", "VendorGuid"}, {"PVOID", "Value"}, {"PULONG", "ValueLength"}, {"PULONG", "Attributes"}}},
        {"_ZwQuerySystemEnvironmentValue@16", 4, {{"PUNICODE_STRING", "VariableName"}, {"PWSTR", "VariableValue"}, {"USHORT", "ValueLength"}, {"PUSHORT", "ReturnLength"}}},
        {"_ZwQuerySystemInformationEx@24", 6, {{"SYSTEM_INFORMATION_CLASS", "SystemInformationClass"}, {"PVOID", "QueryInformation"}, {"ULONG", "QueryInformationLength"}, {"PVOID", "SystemInformation"}, {"ULONG", "SystemInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_NtQuerySystemInformation@16", 4, {{"SYSTEM_INFORMATION_CLASS", "SystemInformationClass"}, {"PVOID", "SystemInformation"}, {"ULONG", "SystemInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_NtQuerySystemTime@4", 1, {{"PLARGE_INTEGER", "SystemTime"}}},
        {"_ZwQueryTimer@20", 5, {{"HANDLE", "TimerHandle"}, {"TIMER_INFORMATION_CLASS", "TimerInformationClass"}, {"PVOID", "TimerInformation"}, {"ULONG", "TimerInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_NtQueryTimerResolution@12", 3, {{"PULONG", "MaximumTime"}, {"PULONG", "MinimumTime"}, {"PULONG", "CurrentTime"}}},
        {"_ZwQueryValueKey@24", 6, {{"HANDLE", "KeyHandle"}, {"PUNICODE_STRING", "ValueName"}, {"KEY_VALUE_INFORMATION_CLASS", "KeyValueInformationClass"}, {"PVOID", "KeyValueInformation"}, {"ULONG", "Length"}, {"PULONG", "ResultLength"}}},
        {"_NtQueryVirtualMemory@24", 6, {{"HANDLE", "ProcessHandle"}, {"PVOID", "BaseAddress"}, {"MEMORY_INFORMATION_CLASS", "MemoryInformationClass"}, {"PVOID", "MemoryInformation"}, {"SIZE_T", "MemoryInformationLength"}, {"PSIZE_T", "ReturnLength"}}},
        {"_NtQueryVolumeInformationFile@20", 5, {{"HANDLE", "FileHandle"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PVOID", "FsInformation"}, {"ULONG", "Length"}, {"FS_INFORMATION_CLASS", "FsInformationClass"}}},
        {"_NtQueueApcThreadEx@24", 6, {{"HANDLE", "ThreadHandle"}, {"HANDLE", "UserApcReserveHandle"}, {"PPS_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcArgument1"}, {"PVOID", "ApcArgument2"}, {"PVOID", "ApcArgument3"}}},
        {"_NtQueueApcThread@20", 5, {{"HANDLE", "ThreadHandle"}, {"PPS_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcArgument1"}, {"PVOID", "ApcArgument2"}, {"PVOID", "ApcArgument3"}}},
        {"_ZwRaiseException@12", 3, {{"PEXCEPTION_RECORD", "ExceptionRecord"}, {"PCONTEXT", "ContextRecord"}, {"BOOLEAN", "FirstChance"}}},
        {"_ZwRaiseHardError@24", 6, {{"NTSTATUS", "ErrorStatus"}, {"ULONG", "NumberOfParameters"}, {"ULONG", "UnicodeStringParameterMask"}, {"PULONG_PTR", "Parameters"}, {"ULONG", "ValidResponseOptions"}, {"PULONG", "Response"}}},
        {"_NtReadFile@36", 9, {{"HANDLE", "FileHandle"}, {"HANDLE", "Event"}, {"PIO_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcContext"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PVOID", "Buffer"}, {"ULONG", "Length"}, {"PLARGE_INTEGER", "ByteOffset"}, {"PULONG", "Key"}}},
        {"_NtReadFileScatter@36", 9, {{"HANDLE", "FileHandle"}, {"HANDLE", "Event"}, {"PIO_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcContext"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PFILE_SEGMENT_ELEMENT", "SegmentArray"}, {"ULONG", "Length"}, {"PLARGE_INTEGER", "ByteOffset"}, {"PULONG", "Key"}}},
        {"_ZwReadOnlyEnlistment@8", 2, {{"HANDLE", "EnlistmentHandle"}, {"PLARGE_INTEGER", "TmVirtualClock"}}},
        {"_ZwReadRequestData@24", 6, {{"HANDLE", "PortHandle"}, {"PPORT_MESSAGE", "Message"}, {"ULONG", "DataEntryIndex"}, {"PVOID", "Buffer"}, {"SIZE_T", "BufferSize"}, {"PSIZE_T", "NumberOfBytesRead"}}},
        {"_NtReadVirtualMemory@20", 5, {{"HANDLE", "ProcessHandle"}, {"PVOID", "BaseAddress"}, {"PVOID", "Buffer"}, {"SIZE_T", "BufferSize"}, {"PSIZE_T", "NumberOfBytesRead"}}},
        {"_NtRecoverEnlistment@8", 2, {{"HANDLE", "EnlistmentHandle"}, {"PVOID", "EnlistmentKey"}}},
        {"_NtRecoverResourceManager@4", 1, {{"HANDLE", "ResourceManagerHandle"}}},
        {"_ZwRecoverTransactionManager@4", 1, {{"HANDLE", "TransactionManagerHandle"}}},
        {"_ZwRegisterProtocolAddressInformation@20", 5, {{"HANDLE", "ResourceManager"}, {"PCRM_PROTOCOL_ID", "ProtocolId"}, {"ULONG", "ProtocolInformationSize"}, {"PVOID", "ProtocolInformation"}, {"ULONG", "CreateOptions"}}},
        {"_ZwRegisterThreadTerminatePort@4", 1, {{"HANDLE", "PortHandle"}}},
        {"_NtReleaseKeyedEvent@16", 4, {{"HANDLE", "KeyedEventHandle"}, {"PVOID", "KeyValue"}, {"BOOLEAN", "Alertable"}, {"PLARGE_INTEGER", "Timeout"}}},
        {"_ZwReleaseMutant@8", 2, {{"HANDLE", "MutantHandle"}, {"PLONG", "PreviousCount"}}},
        {"_NtReleaseSemaphore@12", 3, {{"HANDLE", "SemaphoreHandle"}, {"LONG", "ReleaseCount"}, {"PLONG", "PreviousCount"}}},
        {"_ZwReleaseWorkerFactoryWorker@4", 1, {{"HANDLE", "WorkerFactoryHandle"}}},
        {"_ZwRemoveIoCompletionEx@24", 6, {{"HANDLE", "IoCompletionHandle"}, {"PFILE_IO_COMPLETION_INFORMATION", "IoCompletionInformation"}, {"ULONG", "Count"}, {"PULONG", "NumEntriesRemoved"}, {"PLARGE_INTEGER", "Timeout"}, {"BOOLEAN", "Alertable"}}},
        {"_ZwRemoveIoCompletion@20", 5, {{"HANDLE", "IoCompletionHandle"}, {"PVOID", "STARKeyContext"}, {"PVOID", "STARApcContext"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PLARGE_INTEGER", "Timeout"}}},
        {"_ZwRemoveProcessDebug@8", 2, {{"HANDLE", "ProcessHandle"}, {"HANDLE", "DebugObjectHandle"}}},
        {"_ZwRenameKey@8", 2, {{"HANDLE", "KeyHandle"}, {"PUNICODE_STRING", "NewName"}}},
        {"_NtRenameTransactionManager@8", 2, {{"PUNICODE_STRING", "LogFileName"}, {"LPGUID", "ExistingTransactionManagerGuid"}}},
        {"_ZwReplaceKey@12", 3, {{"POBJECT_ATTRIBUTES", "NewFile"}, {"HANDLE", "TargetHandle"}, {"POBJECT_ATTRIBUTES", "OldFile"}}},
        {"_NtReplacePartitionUnit@12", 3, {{"PUNICODE_STRING", "TargetInstancePath"}, {"PUNICODE_STRING", "SpareInstancePath"}, {"ULONG", "Flags"}}},
        {"_ZwReplyPort@8", 2, {{"HANDLE", "PortHandle"}, {"PPORT_MESSAGE", "ReplyMessage"}}},
        {"_NtReplyWaitReceivePortEx@20", 5, {{"HANDLE", "PortHandle"}, {"PVOID", "STARPortContext"}, {"PPORT_MESSAGE", "ReplyMessage"}, {"PPORT_MESSAGE", "ReceiveMessage"}, {"PLARGE_INTEGER", "Timeout"}}},
        {"_NtReplyWaitReceivePort@16", 4, {{"HANDLE", "PortHandle"}, {"PVOID", "STARPortContext"}, {"PPORT_MESSAGE", "ReplyMessage"}, {"PPORT_MESSAGE", "ReceiveMessage"}}},
        {"_NtReplyWaitReplyPort@8", 2, {{"HANDLE", "PortHandle"}, {"PPORT_MESSAGE", "ReplyMessage"}}},
        {"_ZwRequestPort@8", 2, {{"HANDLE", "PortHandle"}, {"PPORT_MESSAGE", "RequestMessage"}}},
        {"_NtRequestWaitReplyPort@12", 3, {{"HANDLE", "PortHandle"}, {"PPORT_MESSAGE", "RequestMessage"}, {"PPORT_MESSAGE", "ReplyMessage"}}},
        {"_NtResetEvent@8", 2, {{"HANDLE", "EventHandle"}, {"PLONG", "PreviousState"}}},
        {"_ZwResetWriteWatch@12", 3, {{"HANDLE", "ProcessHandle"}, {"PVOID", "BaseAddress"}, {"SIZE_T", "RegionSize"}}},
        {"_NtRestoreKey@12", 3, {{"HANDLE", "KeyHandle"}, {"HANDLE", "FileHandle"}, {"ULONG", "Flags"}}},
        {"_ZwResumeProcess@4", 1, {{"HANDLE", "ProcessHandle"}}},
        {"_ZwResumeThread@8", 2, {{"HANDLE", "ThreadHandle"}, {"PULONG", "PreviousSuspendCount"}}},
        {"_ZwRollbackComplete@8", 2, {{"HANDLE", "EnlistmentHandle"}, {"PLARGE_INTEGER", "TmVirtualClock"}}},
        {"_NtRollbackEnlistment@8", 2, {{"HANDLE", "EnlistmentHandle"}, {"PLARGE_INTEGER", "TmVirtualClock"}}},
        {"_NtRollbackTransaction@8", 2, {{"HANDLE", "TransactionHandle"}, {"BOOLEAN", "Wait"}}},
        {"_NtRollforwardTransactionManager@8", 2, {{"HANDLE", "TransactionManagerHandle"}, {"PLARGE_INTEGER", "TmVirtualClock"}}},
        {"_NtSaveKeyEx@12", 3, {{"HANDLE", "KeyHandle"}, {"HANDLE", "FileHandle"}, {"ULONG", "Format"}}},
        {"_NtSaveKey@8", 2, {{"HANDLE", "KeyHandle"}, {"HANDLE", "FileHandle"}}},
        {"_NtSaveMergedKeys@12", 3, {{"HANDLE", "HighPrecedenceKeyHandle"}, {"HANDLE", "LowPrecedenceKeyHandle"}, {"HANDLE", "FileHandle"}}},
        {"_NtSecureConnectPort@36", 9, {{"PHANDLE", "PortHandle"}, {"PUNICODE_STRING", "PortName"}, {"PSECURITY_QUALITY_OF_SERVICE", "SecurityQos"}, {"PPORT_VIEW", "ClientView"}, {"PSID", "RequiredServerSid"}, {"PREMOTE_PORT_VIEW", "ServerView"}, {"PULONG", "MaxMessageLength"}, {"PVOID", "ConnectionInformation"}, {"PULONG", "ConnectionInformationLength"}}},
        {"_ZwSetBootEntryOrder@8", 2, {{"PULONG", "Ids"}, {"ULONG", "Count"}}},
        {"_ZwSetBootOptions@8", 2, {{"PBOOT_OPTIONS", "BootOptions"}, {"ULONG", "FieldsToChange"}}},
        {"_ZwSetContextThread@8", 2, {{"HANDLE", "ThreadHandle"}, {"PCONTEXT", "ThreadContext"}}},
        {"_NtSetDebugFilterState@12", 3, {{"ULONG", "ComponentId"}, {"ULONG", "Level"}, {"BOOLEAN", "State"}}},
        {"_NtSetDefaultHardErrorPort@4", 1, {{"HANDLE", "DefaultHardErrorPort"}}},
        {"_NtSetDefaultLocale@8", 2, {{"BOOLEAN", "UserProfile"}, {"LCID", "DefaultLocaleId"}}},
        {"_ZwSetDefaultUILanguage@4", 1, {{"LANGID", "DefaultUILanguageId"}}},
        {"_NtSetDriverEntryOrder@8", 2, {{"PULONG", "Ids"}, {"ULONG", "Count"}}},
        {"_ZwSetEaFile@16", 4, {{"HANDLE", "FileHandle"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PVOID", "Buffer"}, {"ULONG", "Length"}}},
        {"_NtSetEventBoostPriority@4", 1, {{"HANDLE", "EventHandle"}}},
        {"_NtSetEvent@8", 2, {{"HANDLE", "EventHandle"}, {"PLONG", "PreviousState"}}},
        {"_NtSetHighEventPair@4", 1, {{"HANDLE", "EventPairHandle"}}},
        {"_NtSetHighWaitLowEventPair@4", 1, {{"HANDLE", "EventPairHandle"}}},
        {"_ZwSetInformationDebugObject@20", 5, {{"HANDLE", "DebugObjectHandle"}, {"DEBUGOBJECTINFOCLASS", "DebugObjectInformationClass"}, {"PVOID", "DebugInformation"}, {"ULONG", "DebugInformationLength"}, {"PULONG", "ReturnLength"}}},
        {"_NtSetInformationEnlistment@16", 4, {{"HANDLE", "EnlistmentHandle"}, {"ENLISTMENT_INFORMATION_CLASS", "EnlistmentInformationClass"}, {"PVOID", "EnlistmentInformation"}, {"ULONG", "EnlistmentInformationLength"}}},
        {"_ZwSetInformationFile@20", 5, {{"HANDLE", "FileHandle"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PVOID", "FileInformation"}, {"ULONG", "Length"}, {"FILE_INFORMATION_CLASS", "FileInformationClass"}}},
        {"_ZwSetInformationJobObject@16", 4, {{"HANDLE", "JobHandle"}, {"JOBOBJECTINFOCLASS", "JobObjectInformationClass"}, {"PVOID", "JobObjectInformation"}, {"ULONG", "JobObjectInformationLength"}}},
        {"_ZwSetInformationKey@16", 4, {{"HANDLE", "KeyHandle"}, {"KEY_SET_INFORMATION_CLASS", "KeySetInformationClass"}, {"PVOID", "KeySetInformation"}, {"ULONG", "KeySetInformationLength"}}},
        {"_ZwSetInformationObject@16", 4, {{"HANDLE", "Handle"}, {"OBJECT_INFORMATION_CLASS", "ObjectInformationClass"}, {"PVOID", "ObjectInformation"}, {"ULONG", "ObjectInformationLength"}}},
        {"_ZwSetInformationProcess@16", 4, {{"HANDLE", "ProcessHandle"}, {"PROCESSINFOCLASS", "ProcessInformationClass"}, {"PVOID", "ProcessInformation"}, {"ULONG", "ProcessInformationLength"}}},
        {"_ZwSetInformationResourceManager@16", 4, {{"HANDLE", "ResourceManagerHandle"}, {"RESOURCEMANAGER_INFORMATION_CLASS", "ResourceManagerInformationClass"}, {"PVOID", "ResourceManagerInformation"}, {"ULONG", "ResourceManagerInformationLength"}}},
        {"_ZwSetInformationThread@16", 4, {{"HANDLE", "ThreadHandle"}, {"THREADINFOCLASS", "ThreadInformationClass"}, {"PVOID", "ThreadInformation"}, {"ULONG", "ThreadInformationLength"}}},
        {"_ZwSetInformationToken@16", 4, {{"HANDLE", "TokenHandle"}, {"TOKEN_INFORMATION_CLASS", "TokenInformationClass"}, {"PVOID", "TokenInformation"}, {"ULONG", "TokenInformationLength"}}},
        {"_ZwSetInformationTransaction@16", 4, {{"HANDLE", "TransactionHandle"}, {"TRANSACTION_INFORMATION_CLASS", "TransactionInformationClass"}, {"PVOID", "TransactionInformation"}, {"ULONG", "TransactionInformationLength"}}},
        {"_ZwSetInformationTransactionManager@16", 4, {{"HANDLE", "TmHandle"}, {"TRANSACTIONMANAGER_INFORMATION_CLASS", "TransactionManagerInformationClass"}, {"PVOID", "TransactionManagerInformation"}, {"ULONG", "TransactionManagerInformationLength"}}},
        {"_ZwSetInformationWorkerFactory@16", 4, {{"HANDLE", "WorkerFactoryHandle"}, {"WORKERFACTORYINFOCLASS", "WorkerFactoryInformationClass"}, {"PVOID", "WorkerFactoryInformation"}, {"ULONG", "WorkerFactoryInformationLength"}}},
        {"_NtSetIntervalProfile@8", 2, {{"ULONG", "Interval"}, {"KPROFILE_SOURCE", "Source"}}},
        {"_NtSetIoCompletionEx@24", 6, {{"HANDLE", "IoCompletionHandle"}, {"HANDLE", "IoCompletionReserveHandle"}, {"PVOID", "KeyContext"}, {"PVOID", "ApcContext"}, {"NTSTATUS", "IoStatus"}, {"ULONG_PTR", "IoStatusInformation"}}},
        {"_NtSetIoCompletion@20", 5, {{"HANDLE", "IoCompletionHandle"}, {"PVOID", "KeyContext"}, {"PVOID", "ApcContext"}, {"NTSTATUS", "IoStatus"}, {"ULONG_PTR", "IoStatusInformation"}}},
        {"_ZwSetLdtEntries@24", 6, {{"ULONG", "Selector0"}, {"ULONG", "Entry0Low"}, {"ULONG", "Entry0Hi"}, {"ULONG", "Selector1"}, {"ULONG", "Entry1Low"}, {"ULONG", "Entry1Hi"}}},
        {"_ZwSetLowEventPair@4", 1, {{"HANDLE", "EventPairHandle"}}},
        {"_ZwSetLowWaitHighEventPair@4", 1, {{"HANDLE", "EventPairHandle"}}},
        {"_ZwSetQuotaInformationFile@16", 4, {{"HANDLE", "FileHandle"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PVOID", "Buffer"}, {"ULONG", "Length"}}},
        {"_NtSetSecurityObject@12", 3, {{"HANDLE", "Handle"}, {"SECURITY_INFORMATION", "SecurityInformation"}, {"PSECURITY_DESCRIPTOR", "SecurityDescriptor"}}},
        {"_ZwSetSystemEnvironmentValueEx@20", 5, {{"PUNICODE_STRING", "VariableName"}, {"LPGUID", "VendorGuid"}, {"PVOID", "Value"}, {"ULONG", "ValueLength"}, {"ULONG", "Attributes"}}},
        {"_ZwSetSystemEnvironmentValue@8", 2, {{"PUNICODE_STRING", "VariableName"}, {"PUNICODE_STRING", "VariableValue"}}},
        {"_ZwSetSystemInformation@12", 3, {{"SYSTEM_INFORMATION_CLASS", "SystemInformationClass"}, {"PVOID", "SystemInformation"}, {"ULONG", "SystemInformationLength"}}},
        {"_ZwSetSystemPowerState@12", 3, {{"POWER_ACTION", "SystemAction"}, {"SYSTEM_POWER_STATE", "MinSystemState"}, {"ULONG", "Flags"}}},
        {"_ZwSetSystemTime@8", 2, {{"PLARGE_INTEGER", "SystemTime"}, {"PLARGE_INTEGER", "PreviousTime"}}},
        {"_ZwSetThreadExecutionState@8", 2, {{"EXECUTION_STATE", "esFlags"}, {"EXECUTION_STATE", "STARPreviousFlags"}}},
        {"_ZwSetTimerEx@16", 4, {{"HANDLE", "TimerHandle"}, {"TIMER_SET_INFORMATION_CLASS", "TimerSetInformationClass"}, {"PVOID", "TimerSetInformation"}, {"ULONG", "TimerSetInformationLength"}}},
        {"_ZwSetTimer@28", 7, {{"HANDLE", "TimerHandle"}, {"PLARGE_INTEGER", "DueTime"}, {"PTIMER_APC_ROUTINE", "TimerApcRoutine"}, {"PVOID", "TimerContext"}, {"BOOLEAN", "WakeTimer"}, {"LONG", "Period"}, {"PBOOLEAN", "PreviousState"}}},
        {"_NtSetTimerResolution@12", 3, {{"ULONG", "DesiredTime"}, {"BOOLEAN", "SetResolution"}, {"PULONG", "ActualTime"}}},
        {"_ZwSetUuidSeed@4", 1, {{"PCHAR", "Seed"}}},
        {"_ZwSetValueKey@24", 6, {{"HANDLE", "KeyHandle"}, {"PUNICODE_STRING", "ValueName"}, {"ULONG", "TitleIndex"}, {"ULONG", "Type"}, {"PVOID", "Data"}, {"ULONG", "DataSize"}}},
        {"_NtSetVolumeInformationFile@20", 5, {{"HANDLE", "FileHandle"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PVOID", "FsInformation"}, {"ULONG", "Length"}, {"FS_INFORMATION_CLASS", "FsInformationClass"}}},
        {"_ZwShutdownSystem@4", 1, {{"SHUTDOWN_ACTION", "Action"}}},
        {"_NtShutdownWorkerFactory@8", 2, {{"HANDLE", "WorkerFactoryHandle"}, {"LONG", "STARPendingWorkerCount"}}},
        {"_ZwSignalAndWaitForSingleObject@16", 4, {{"HANDLE", "SignalHandle"}, {"HANDLE", "WaitHandle"}, {"BOOLEAN", "Alertable"}, {"PLARGE_INTEGER", "Timeout"}}},
        {"_ZwSinglePhaseReject@8", 2, {{"HANDLE", "EnlistmentHandle"}, {"PLARGE_INTEGER", "TmVirtualClock"}}},
        {"_NtStartProfile@4", 1, {{"HANDLE", "ProfileHandle"}}},
        {"_ZwStopProfile@4", 1, {{"HANDLE", "ProfileHandle"}}},
        {"_ZwSuspendProcess@4", 1, {{"HANDLE", "ProcessHandle"}}},
        {"_ZwSuspendThread@8", 2, {{"HANDLE", "ThreadHandle"}, {"PULONG", "PreviousSuspendCount"}}},
        {"_NtSystemDebugControl@24", 6, {{"SYSDBG_COMMAND", "Command"}, {"PVOID", "InputBuffer"}, {"ULONG", "InputBufferLength"}, {"PVOID", "OutputBuffer"}, {"ULONG", "OutputBufferLength"}, {"PULONG", "ReturnLength"}}},
        {"_ZwTerminateJobObject@8", 2, {{"HANDLE", "JobHandle"}, {"NTSTATUS", "ExitStatus"}}},
        {"_ZwTerminateProcess@8", 2, {{"HANDLE", "ProcessHandle"}, {"NTSTATUS", "ExitStatus"}}},
        {"_ZwTerminateThread@8", 2, {{"HANDLE", "ThreadHandle"}, {"NTSTATUS", "ExitStatus"}}},
        {"_ZwTraceControl@24", 6, {{"ULONG", "FunctionCode"}, {"PVOID", "InBuffer"}, {"ULONG", "InBufferLen"}, {"PVOID", "OutBuffer"}, {"ULONG", "OutBufferLen"}, {"PULONG", "ReturnLength"}}},
        {"_NtTraceEvent@16", 4, {{"HANDLE", "TraceHandle"}, {"ULONG", "Flags"}, {"ULONG", "FieldSize"}, {"PVOID", "Fields"}}},
        {"_NtTranslateFilePath@16", 4, {{"PFILE_PATH", "InputFilePath"}, {"ULONG", "OutputType"}, {"PFILE_PATH", "OutputFilePath"}, {"PULONG", "OutputFilePathLength"}}},
        {"_ZwUnloadDriver@4", 1, {{"PUNICODE_STRING", "DriverServiceName"}}},
        {"_ZwUnloadKey2@8", 2, {{"POBJECT_ATTRIBUTES", "TargetKey"}, {"ULONG", "Flags"}}},
        {"_ZwUnloadKeyEx@8", 2, {{"POBJECT_ATTRIBUTES", "TargetKey"}, {"HANDLE", "Event"}}},
        {"_NtUnloadKey@4", 1, {{"POBJECT_ATTRIBUTES", "TargetKey"}}},
        {"_ZwUnlockFile@20", 5, {{"HANDLE", "FileHandle"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PLARGE_INTEGER", "ByteOffset"}, {"PLARGE_INTEGER", "Length"}, {"ULONG", "Key"}}},
        {"_NtUnlockVirtualMemory@16", 4, {{"HANDLE", "ProcessHandle"}, {"PVOID", "STARBaseAddress"}, {"PSIZE_T", "RegionSize"}, {"ULONG", "MapType"}}},
        {"_NtUnmapViewOfSection@8", 2, {{"HANDLE", "ProcessHandle"}, {"PVOID", "BaseAddress"}}},
        {"_NtVdmControl@8", 2, {{"VDMSERVICECLASS", "Service"}, {"PVOID", "ServiceData"}}},
        {"_NtWaitForDebugEvent@16", 4, {{"HANDLE", "DebugObjectHandle"}, {"BOOLEAN", "Alertable"}, {"PLARGE_INTEGER", "Timeout"}, {"PDBGUI_WAIT_STATE_CHANGE", "WaitStateChange"}}},
        {"_NtWaitForKeyedEvent@16", 4, {{"HANDLE", "KeyedEventHandle"}, {"PVOID", "KeyValue"}, {"BOOLEAN", "Alertable"}, {"PLARGE_INTEGER", "Timeout"}}},
        {"_NtWaitForMultipleObjects32@20", 5, {{"ULONG", "Count"}, {"LONG", "Handles"}, {"WAIT_TYPE", "WaitType"}, {"BOOLEAN", "Alertable"}, {"PLARGE_INTEGER", "Timeout"}}},
        {"_NtWaitForMultipleObjects@20", 5, {{"ULONG", "Count"}, {"HANDLE", "Handles"}, {"WAIT_TYPE", "WaitType"}, {"BOOLEAN", "Alertable"}, {"PLARGE_INTEGER", "Timeout"}}},
        {"_ZwWaitForSingleObject@12", 3, {{"HANDLE", "Handle"}, {"BOOLEAN", "Alertable"}, {"PLARGE_INTEGER", "Timeout"}}},
        {"_NtWaitForWorkViaWorkerFactory@20", 5, {{"HANDLE", "WorkerFactoryHandle"}, {"PFILE_IO_COMPLETION_INFORMATION", "MiniPacket"}, {"PVOID", "Arg2"}, {"PVOID", "Arg3"}, {"PVOID", "Arg4"}}},
        {"_ZwWaitHighEventPair@4", 1, {{"HANDLE", "EventPairHandle"}}},
        {"_NtWaitLowEventPair@4", 1, {{"HANDLE", "EventPairHandle"}}},
        {"_NtWorkerFactoryWorkerReady@4", 1, {{"HANDLE", "WorkerFactoryHandle"}}},
        {"_NtWriteFileGather@36", 9, {{"HANDLE", "FileHandle"}, {"HANDLE", "Event"}, {"PIO_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcContext"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PFILE_SEGMENT_ELEMENT", "SegmentArray"}, {"ULONG", "Length"}, {"PLARGE_INTEGER", "ByteOffset"}, {"PULONG", "Key"}}},
        {"_NtWriteFile@36", 9, {{"HANDLE", "FileHandle"}, {"HANDLE", "Event"}, {"PIO_APC_ROUTINE", "ApcRoutine"}, {"PVOID", "ApcContext"}, {"PIO_STATUS_BLOCK", "IoStatusBlock"}, {"PVOID", "Buffer"}, {"ULONG", "Length"}, {"PLARGE_INTEGER", "ByteOffset"}, {"PULONG", "Key"}}},
        {"_NtWriteRequestData@24", 6, {{"HANDLE", "PortHandle"}, {"PPORT_MESSAGE", "Message"}, {"ULONG", "DataEntryIndex"}, {"PVOID", "Buffer"}, {"SIZE_T", "BufferSize"}, {"PSIZE_T", "NumberOfBytesWritten"}}},
        {"_NtWriteVirtualMemory@20", 5, {{"HANDLE", "ProcessHandle"}, {"PVOID", "BaseAddress"}, {"PVOID", "Buffer"}, {"SIZE_T", "BufferSize"}, {"PSIZE_T", "NumberOfBytesWritten"}}},
        ...
        {"_ZwUmsThreadYield@4", 1, {{"PVOID", "SchedulerParam"}}},
