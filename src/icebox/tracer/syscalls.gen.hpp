...
namespace nt
{
    ...
    using on_ZwAccessCheckByTypeAndAuditAlarm_fn                   = std::function<NTSTATUS(PUNICODE_STRING, PVOID, PUNICODE_STRING, PUNICODE_STRING, PSECURITY_DESCRIPTOR, PSID, ACCESS_MASK, AUDIT_EVENT_TYPE, ULONG, POBJECT_TYPE_LIST, ULONG, PGENERIC_MAPPING, BOOLEAN, PACCESS_MASK, PNTSTATUS, PBOOLEAN)>;
    using on_ZwAccessCheckByType_fn                                = std::function<NTSTATUS(PSECURITY_DESCRIPTOR, PSID, HANDLE, ACCESS_MASK, POBJECT_TYPE_LIST, ULONG, PGENERIC_MAPPING, PPRIVILEGE_SET, PULONG, PACCESS_MASK, PNTSTATUS)>;
    ...
    using on_ZwAccessCheckByTypeResultListAndAuditAlarm_fn         = std::function<NTSTATUS(PUNICODE_STRING, PVOID, PUNICODE_STRING, PUNICODE_STRING, PSECURITY_DESCRIPTOR, PSID, ACCESS_MASK, AUDIT_EVENT_TYPE, ULONG, POBJECT_TYPE_LIST, ULONG, PGENERIC_MAPPING, BOOLEAN, PACCESS_MASK, PNTSTATUS, PBOOLEAN)>;
    using on_ZwAccessCheckByTypeResultList_fn                      = std::function<NTSTATUS(PSECURITY_DESCRIPTOR, PSID, HANDLE, ACCESS_MASK, POBJECT_TYPE_LIST, ULONG, PGENERIC_MAPPING, PPRIVILEGE_SET, PULONG, PACCESS_MASK, PNTSTATUS)>;
    using on_ZwAccessCheck_fn                                      = std::function<NTSTATUS(PSECURITY_DESCRIPTOR, HANDLE, ACCESS_MASK, PGENERIC_MAPPING, PPRIVILEGE_SET, PULONG, PACCESS_MASK, PNTSTATUS)>;
    using on_ZwAddAtom_fn                                          = std::function<NTSTATUS(PWSTR, ULONG, PRTL_ATOM)>;
    ...
    using on_ZwAlertResumeThread_fn                                = std::function<NTSTATUS(HANDLE, PULONG)>;
    ...
    using on_ZwAllocateUserPhysicalPages_fn                        = std::function<NTSTATUS(HANDLE, PULONG_PTR, PULONG_PTR)>;
    using on_ZwAllocateUuids_fn                                    = std::function<NTSTATUS(PULARGE_INTEGER, PULONG, PULONG, PCHAR)>;
    using on_ZwAllocateVirtualMemory_fn                            = std::function<NTSTATUS(HANDLE, PVOID, ULONG_PTR, PSIZE_T, ULONG, ULONG)>;
    using on_ZwAlpcAcceptConnectPort_fn                            = std::function<NTSTATUS(PHANDLE, HANDLE, ULONG, POBJECT_ATTRIBUTES, PALPC_PORT_ATTRIBUTES, PVOID, PPORT_MESSAGE, PALPC_MESSAGE_ATTRIBUTES, BOOLEAN)>;
    ...
    using on_ZwAlpcCreatePortSection_fn                            = std::function<NTSTATUS(HANDLE, ULONG, HANDLE, SIZE_T, PALPC_HANDLE, PSIZE_T)>;
    ...
    using on_ZwAlpcDeleteSectionView_fn                            = std::function<NTSTATUS(HANDLE, ULONG, PVOID)>;
    using on_ZwAlpcDeleteSecurityContext_fn                        = std::function<NTSTATUS(HANDLE, ULONG, ALPC_HANDLE)>;
    ...
    using on_ZwAlpcSendWaitReceivePort_fn                          = std::function<NTSTATUS(HANDLE, ULONG, PPORT_MESSAGE, PALPC_MESSAGE_ATTRIBUTES, PPORT_MESSAGE, PULONG, PALPC_MESSAGE_ATTRIBUTES, PLARGE_INTEGER)>;
    ...
    using on_ZwCancelIoFileEx_fn                                   = std::function<NTSTATUS(HANDLE, PIO_STATUS_BLOCK, PIO_STATUS_BLOCK)>;
    using on_ZwCancelIoFile_fn                                     = std::function<NTSTATUS(HANDLE, PIO_STATUS_BLOCK)>;
    using on_ZwCancelSynchronousIoFile_fn                          = std::function<NTSTATUS(HANDLE, PIO_STATUS_BLOCK, PIO_STATUS_BLOCK)>;
    ...
    using on_ZwCommitEnlistment_fn                                 = std::function<NTSTATUS(HANDLE, PLARGE_INTEGER)>;
    using on_ZwCommitTransaction_fn                                = std::function<NTSTATUS(HANDLE, BOOLEAN)>;
    ...
    using on_ZwConnectPort_fn                                      = std::function<NTSTATUS(PHANDLE, PUNICODE_STRING, PSECURITY_QUALITY_OF_SERVICE, PPORT_VIEW, PREMOTE_PORT_VIEW, PULONG, PVOID, PULONG)>;
    ...
    using on_ZwCreateEvent_fn                                      = std::function<NTSTATUS(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, EVENT_TYPE, BOOLEAN)>;
    using on_ZwCreateEventPair_fn                                  = std::function<NTSTATUS(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES)>;
    using on_ZwCreateFile_fn                                       = std::function<NTSTATUS(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, PIO_STATUS_BLOCK, PLARGE_INTEGER, ULONG, ULONG, ULONG, ULONG, PVOID, ULONG)>;
    ...
    using on_ZwCreateJobSet_fn                                     = std::function<NTSTATUS(ULONG, PJOB_SET_ARRAY, ULONG)>;
    ...
    using on_ZwCreateKeyTransacted_fn                              = std::function<NTSTATUS(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, ULONG, PUNICODE_STRING, ULONG, HANDLE, PULONG)>;
    ...
    using on_ZwCreatePrivateNamespace_fn                           = std::function<NTSTATUS(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, PVOID)>;
    ...
    using on_ZwCreateProfileEx_fn                                  = std::function<NTSTATUS(PHANDLE, HANDLE, PVOID, SIZE_T, ULONG, PULONG, ULONG, KPROFILE_SOURCE, ULONG, PGROUP_AFFINITY)>;
    ...
    using on_ZwDeleteObjectAuditAlarm_fn                           = std::function<NTSTATUS(PUNICODE_STRING, PVOID, BOOLEAN)>;
    using on_NtDeletePrivateNamespace_fn                           = std::function<NTSTATUS(HANDLE)>;
    using on_ZwDeleteValueKey_fn                                   = std::function<NTSTATUS(HANDLE, PUNICODE_STRING)>;
    ...
    using on_ZwDisplayString_fn                                    = std::function<NTSTATUS(PUNICODE_STRING)>;
    ...
    using on_ZwEnumerateDriverEntries_fn                           = std::function<NTSTATUS(PVOID, PULONG)>;
    ...
    using on_ZwEnumerateValueKey_fn                                = std::function<NTSTATUS(HANDLE, ULONG, KEY_VALUE_INFORMATION_CLASS, PVOID, ULONG, PULONG)>;
    using on_NtExtendSection_fn                                    = std::function<NTSTATUS(HANDLE, PLARGE_INTEGER)>;
    using on_ZwFilterToken_fn                                      = std::function<NTSTATUS(HANDLE, ULONG, PTOKEN_GROUPS, PTOKEN_PRIVILEGES, PTOKEN_GROUPS, PHANDLE)>;
    using on_ZwFindAtom_fn                                         = std::function<NTSTATUS(PWSTR, ULONG, PRTL_ATOM)>;
    ...
    using on_ZwFlushKey_fn                                         = std::function<NTSTATUS(HANDLE)>;
    using on_ZwFlushVirtualMemory_fn                               = std::function<NTSTATUS(HANDLE, PVOID, PSIZE_T, PIO_STATUS_BLOCK)>;
    using on_ZwFreeUserPhysicalPages_fn                            = std::function<NTSTATUS(HANDLE, PULONG_PTR, PULONG_PTR)>;
    using on_ZwFreeVirtualMemory_fn                                = std::function<NTSTATUS(HANDLE, PVOID, PSIZE_T, ULONG)>;
    ...
    using on_ZwFsControlFile_fn                                    = std::function<NTSTATUS(HANDLE, HANDLE, PIO_APC_ROUTINE, PVOID, PIO_STATUS_BLOCK, ULONG, PVOID, ULONG, PVOID, ULONG)>;
    using on_ZwGetContextThread_fn                                 = std::function<NTSTATUS(HANDLE, PCONTEXT)>;
    using on_ZwGetDevicePowerState_fn                              = std::function<NTSTATUS(HANDLE, DEVICE_POWER_STATE)>;
    using on_ZwGetMUIRegistryInfo_fn                               = std::function<NTSTATUS(ULONG, PULONG, PVOID)>;
    ...
    using on_ZwGetNlsSectionPtr_fn                                 = std::function<NTSTATUS(ULONG, ULONG, PVOID, PVOID, PULONG)>;
    ...
    using on_ZwGetWriteWatch_fn                                    = std::function<NTSTATUS(HANDLE, ULONG, PVOID, SIZE_T, PVOID, PULONG_PTR, PULONG)>;
    using on_ZwImpersonateAnonymousToken_fn                        = std::function<NTSTATUS(HANDLE)>;
    ...
    using on_ZwLoadDriver_fn                                       = std::function<NTSTATUS(PUNICODE_STRING)>;
    using on_ZwLoadKey2_fn                                         = std::function<NTSTATUS(POBJECT_ATTRIBUTES, POBJECT_ATTRIBUTES, ULONG)>;
    ...
    using on_ZwLockFile_fn                                         = std::function<NTSTATUS(HANDLE, HANDLE, PIO_APC_ROUTINE, PVOID, PIO_STATUS_BLOCK, PLARGE_INTEGER, PLARGE_INTEGER, ULONG, BOOLEAN, BOOLEAN)>;
    using on_NtLockProductActivationKeys_fn                        = std::function<NTSTATUS(ULONG, ULONG)>;
    using on_ZwLockRegistryKey_fn                                  = std::function<NTSTATUS(HANDLE)>;
    ...
    using on_ZwNotifyChangeKey_fn                                  = std::function<NTSTATUS(HANDLE, HANDLE, PIO_APC_ROUTINE, PVOID, PIO_STATUS_BLOCK, ULONG, BOOLEAN, PVOID, ULONG, BOOLEAN)>;
    ...
    using on_ZwOpenEventPair_fn                                    = std::function<NTSTATUS(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES)>;
    ...
    using on_ZwOpenKeyTransactedEx_fn                              = std::function<NTSTATUS(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, ULONG, HANDLE)>;
    using on_ZwOpenKeyTransacted_fn                                = std::function<NTSTATUS(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, HANDLE)>;
    ...
    using on_ZwOpenSemaphore_fn                                    = std::function<NTSTATUS(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES)>;
    using on_ZwOpenSession_fn                                      = std::function<NTSTATUS(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES)>;
    using on_ZwOpenSymbolicLinkObject_fn                           = std::function<NTSTATUS(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES)>;
    ...
    using on_ZwPlugPlayControl_fn                                  = std::function<NTSTATUS(PLUGPLAY_CONTROL_CLASS, PVOID, ULONG)>;
    using on_NtPowerInformation_fn                                 = std::function<NTSTATUS(POWER_INFORMATION_LEVEL, PVOID, ULONG, PVOID, ULONG)>;
    using on_ZwPrepareComplete_fn                                  = std::function<NTSTATUS(HANDLE, PLARGE_INTEGER)>;
    ...
    using on_ZwPrivilegedServiceAuditAlarm_fn                      = std::function<NTSTATUS(PUNICODE_STRING, PUNICODE_STRING, HANDLE, PPRIVILEGE_SET, BOOLEAN)>;
    ...
    using on_ZwQueryDebugFilterState_fn                            = std::function<NTSTATUS(ULONG, ULONG)>;
    ...
    using on_ZwQueryInformationThread_fn                           = std::function<NTSTATUS(HANDLE, THREADINFOCLASS, PVOID, ULONG, PULONG)>;
    ...
    using on_ZwQueryLicenseValue_fn                                = std::function<NTSTATUS(PUNICODE_STRING, PULONG, PVOID, ULONG, PULONG)>;
    using on_ZwQueryMultipleValueKey_fn                            = std::function<NTSTATUS(HANDLE, PKEY_VALUE_ENTRY, ULONG, PVOID, PULONG, PULONG)>;
    using on_ZwQueryMutant_fn                                      = std::function<NTSTATUS(HANDLE, MUTANT_INFORMATION_CLASS, PVOID, ULONG, PULONG)>;
    using on_ZwQueryObject_fn                                      = std::function<NTSTATUS(HANDLE, OBJECT_INFORMATION_CLASS, PVOID, ULONG, PULONG)>;
    ...
    using on_ZwQuerySystemTime_fn                                  = std::function<NTSTATUS(PLARGE_INTEGER)>;
    using on_ZwQueryTimer_fn                                       = std::function<NTSTATUS(HANDLE, TIMER_INFORMATION_CLASS, PVOID, ULONG, PULONG)>;
    using on_ZwQueryTimerResolution_fn                             = std::function<NTSTATUS(PULONG, PULONG, PULONG)>;
    using on_NtQueryValueKey_fn                                    = std::function<NTSTATUS(HANDLE, PUNICODE_STRING, KEY_VALUE_INFORMATION_CLASS, PVOID, ULONG, PULONG)>;
    using on_ZwQueryVirtualMemory_fn                               = std::function<NTSTATUS(HANDLE, PVOID, MEMORY_INFORMATION_CLASS, PVOID, SIZE_T, PSIZE_T)>;
    using on_ZwQueryVolumeInformationFile_fn                       = std::function<NTSTATUS(HANDLE, PIO_STATUS_BLOCK, PVOID, ULONG, FS_INFORMATION_CLASS)>;
    ...
    using on_ZwReadFileScatter_fn                                  = std::function<NTSTATUS(HANDLE, HANDLE, PIO_APC_ROUTINE, PVOID, PIO_STATUS_BLOCK, PFILE_SEGMENT_ELEMENT, ULONG, PLARGE_INTEGER, PULONG)>;
    ...
    using on_ZwReadVirtualMemory_fn                                = std::function<NTSTATUS(HANDLE, PVOID, PVOID, SIZE_T, PSIZE_T)>;
    using on_ZwRecoverEnlistment_fn                                = std::function<NTSTATUS(HANDLE, PVOID)>;
    using on_ZwRecoverResourceManager_fn                           = std::function<NTSTATUS(HANDLE)>;
    ...
    using on_ZwReleaseSemaphore_fn                                 = std::function<NTSTATUS(HANDLE, LONG, PLONG)>;
    ...
    using on_ZwReplyWaitReceivePortEx_fn                           = std::function<NTSTATUS(HANDLE, PVOID, PPORT_MESSAGE, PPORT_MESSAGE, PLARGE_INTEGER)>;
    using on_ZwReplyWaitReceivePort_fn                             = std::function<NTSTATUS(HANDLE, PVOID, PPORT_MESSAGE, PPORT_MESSAGE)>;
    ...
    using on_ZwRequestWaitReplyPort_fn                             = std::function<NTSTATUS(HANDLE, PPORT_MESSAGE, PPORT_MESSAGE)>;
    using on_ZwResetEvent_fn                                       = std::function<NTSTATUS(HANDLE, PLONG)>;
    ...
    using on_ZwRollbackTransaction_fn                              = std::function<NTSTATUS(HANDLE, BOOLEAN)>;
    ...
    using on_ZwSaveMergedKeys_fn                                   = std::function<NTSTATUS(HANDLE, HANDLE, HANDLE)>;
    ...
    using on_ZwSetDebugFilterState_fn                              = std::function<NTSTATUS(ULONG, ULONG, BOOLEAN)>;
    ...
    using on_ZwSetEventBoostPriority_fn                            = std::function<NTSTATUS(HANDLE)>;
    using on_ZwSetEvent_fn                                         = std::function<NTSTATUS(HANDLE, PLONG)>;
    using on_NtSetHighEventPair_fn                                 = std::function<NTSTATUS(HANDLE)>;
    using on_ZwSetHighWaitLowEventPair_fn                          = std::function<NTSTATUS(HANDLE)>;
    ...
    using on_ZwSetIoCompletionEx_fn                                = std::function<NTSTATUS(HANDLE, HANDLE, PVOID, PVOID, NTSTATUS, ULONG_PTR)>;
    using on_ZwSetIoCompletion_fn                                  = std::function<NTSTATUS(HANDLE, PVOID, PVOID, NTSTATUS, ULONG_PTR)>;
    ...
    using on_ZwSetVolumeInformationFile_fn                         = std::function<NTSTATUS(HANDLE, PIO_STATUS_BLOCK, PVOID, ULONG, FS_INFORMATION_CLASS)>;
    using on_ZwShutdownSystem_fn                                   = std::function<NTSTATUS(SHUTDOWN_ACTION)>;
    using on_ZwShutdownWorkerFactory_fn                            = std::function<NTSTATUS(HANDLE, LONG)>;
    ...
    using on_ZwStartProfile_fn                                     = std::function<NTSTATUS(HANDLE)>;
    ...
    using on_ZwSystemDebugControl_fn                               = std::function<NTSTATUS(SYSDBG_COMMAND, PVOID, ULONG, PVOID, ULONG, PULONG)>;
    ...
    using on_ZwUnlockVirtualMemory_fn                              = std::function<NTSTATUS(HANDLE, PVOID, PSIZE_T, ULONG)>;
    using on_NtUnmapViewOfSection_fn                               = std::function<NTSTATUS(HANDLE, PVOID)>;
    using on_ZwVdmControl_fn                                       = std::function<NTSTATUS(VDMSERVICECLASS, PVOID)>;
    using on_ZwWaitForDebugEvent_fn                                = std::function<NTSTATUS(HANDLE, BOOLEAN, PLARGE_INTEGER, PDBGUI_WAIT_STATE_CHANGE)>;
    using on_NtWaitForKeyedEvent_fn                                = std::function<NTSTATUS(HANDLE, PVOID, BOOLEAN, PLARGE_INTEGER)>;
    using on_ZwWaitForMultipleObjects32_fn                         = std::function<NTSTATUS(ULONG, LONG, WAIT_TYPE, BOOLEAN, PLARGE_INTEGER)>;
    ...
    using on_ZwWaitForWorkViaWorkerFactory_fn                      = std::function<NTSTATUS(HANDLE, PFILE_IO_COMPLETION_INFORMATION)>;
    ...
    using on_ZwWriteFileGather_fn                                  = std::function<NTSTATUS(HANDLE, HANDLE, PIO_APC_ROUTINE, PVOID, PIO_STATUS_BLOCK, PFILE_SEGMENT_ELEMENT, ULONG, PLARGE_INTEGER, PULONG)>;
    ...
    using on_ZwWriteRequestData_fn                                 = std::function<NTSTATUS(HANDLE, PPORT_MESSAGE, ULONG, PVOID, SIZE_T, PSIZE_T)>;
    ...
    using on_ZwGetCurrentProcessorNumber_fn                        = std::function<ULONG()>;
    using on_ZwIsSystemResumeAutomatic_fn                          = std::function<BOOLEAN()>;
    using on_NtIsUILanguageComitted_fn                             = std::function<NTSTATUS()>;
    using on_NtQueryPortInformationProcess_fn                      = std::function<NTSTATUS()>;
    using on_ZwSerializeBoot_fn                                    = std::function<NTSTATUS()>;
    using on_ZwTestAlert_fn                                        = std::function<NTSTATUS()>;
    using on_ZwThawRegistry_fn                                     = std::function<NTSTATUS()>;
    using on_ZwThawTransactions_fn                                 = std::function<NTSTATUS()>;
    using on_ZwUmsThreadYield_fn                                   = std::function<NTSTATUS()>;
    ...
    struct syscalls
    {
        ...
        opt<id_t> register_ZwAccessCheckByTypeAndAuditAlarm                  (proc_t proc, const on_ZwAccessCheckByTypeAndAuditAlarm_fn& on_func);
        opt<id_t> register_ZwAccessCheckByType                               (proc_t proc, const on_ZwAccessCheckByType_fn& on_func);
        ...
        opt<id_t> register_ZwAccessCheckByTypeResultListAndAuditAlarm        (proc_t proc, const on_ZwAccessCheckByTypeResultListAndAuditAlarm_fn& on_func);
        opt<id_t> register_ZwAccessCheckByTypeResultList                     (proc_t proc, const on_ZwAccessCheckByTypeResultList_fn& on_func);
        opt<id_t> register_ZwAccessCheck                                     (proc_t proc, const on_ZwAccessCheck_fn& on_func);
        opt<id_t> register_ZwAddAtom                                         (proc_t proc, const on_ZwAddAtom_fn& on_func);
        ...
        opt<id_t> register_ZwAlertResumeThread                               (proc_t proc, const on_ZwAlertResumeThread_fn& on_func);
        ...
        opt<id_t> register_ZwAllocateUserPhysicalPages                       (proc_t proc, const on_ZwAllocateUserPhysicalPages_fn& on_func);
        opt<id_t> register_ZwAllocateUuids                                   (proc_t proc, const on_ZwAllocateUuids_fn& on_func);
        opt<id_t> register_ZwAllocateVirtualMemory                           (proc_t proc, const on_ZwAllocateVirtualMemory_fn& on_func);
        opt<id_t> register_ZwAlpcAcceptConnectPort                           (proc_t proc, const on_ZwAlpcAcceptConnectPort_fn& on_func);
        ...
        opt<id_t> register_ZwAlpcCreatePortSection                           (proc_t proc, const on_ZwAlpcCreatePortSection_fn& on_func);
        ...
        opt<id_t> register_ZwAlpcDeleteSectionView                           (proc_t proc, const on_ZwAlpcDeleteSectionView_fn& on_func);
        opt<id_t> register_ZwAlpcDeleteSecurityContext                       (proc_t proc, const on_ZwAlpcDeleteSecurityContext_fn& on_func);
        ...
        opt<id_t> register_ZwAlpcSendWaitReceivePort                         (proc_t proc, const on_ZwAlpcSendWaitReceivePort_fn& on_func);
        ...
        opt<id_t> register_ZwCancelIoFileEx                                  (proc_t proc, const on_ZwCancelIoFileEx_fn& on_func);
        opt<id_t> register_ZwCancelIoFile                                    (proc_t proc, const on_ZwCancelIoFile_fn& on_func);
        opt<id_t> register_ZwCancelSynchronousIoFile                         (proc_t proc, const on_ZwCancelSynchronousIoFile_fn& on_func);
        ...
        opt<id_t> register_ZwCommitEnlistment                                (proc_t proc, const on_ZwCommitEnlistment_fn& on_func);
        opt<id_t> register_ZwCommitTransaction                               (proc_t proc, const on_ZwCommitTransaction_fn& on_func);
        ...
        opt<id_t> register_ZwConnectPort                                     (proc_t proc, const on_ZwConnectPort_fn& on_func);
        ...
        opt<id_t> register_ZwCreateEvent                                     (proc_t proc, const on_ZwCreateEvent_fn& on_func);
        opt<id_t> register_ZwCreateEventPair                                 (proc_t proc, const on_ZwCreateEventPair_fn& on_func);
        opt<id_t> register_ZwCreateFile                                      (proc_t proc, const on_ZwCreateFile_fn& on_func);
        ...
        opt<id_t> register_ZwCreateJobSet                                    (proc_t proc, const on_ZwCreateJobSet_fn& on_func);
        ...
        opt<id_t> register_ZwCreateKeyTransacted                             (proc_t proc, const on_ZwCreateKeyTransacted_fn& on_func);
        ...
        opt<id_t> register_ZwCreatePrivateNamespace                          (proc_t proc, const on_ZwCreatePrivateNamespace_fn& on_func);
        ...
        opt<id_t> register_ZwCreateProfileEx                                 (proc_t proc, const on_ZwCreateProfileEx_fn& on_func);
        ...
        opt<id_t> register_ZwDeleteObjectAuditAlarm                          (proc_t proc, const on_ZwDeleteObjectAuditAlarm_fn& on_func);
        opt<id_t> register_NtDeletePrivateNamespace                          (proc_t proc, const on_NtDeletePrivateNamespace_fn& on_func);
        opt<id_t> register_ZwDeleteValueKey                                  (proc_t proc, const on_ZwDeleteValueKey_fn& on_func);
        opt<id_t> register_NtDeviceIoControlFile                             (proc_t proc, const on_NtDeviceIoControlFile_fn& on_func);
        opt<id_t> register_ZwDisplayString                                   (proc_t proc, const on_ZwDisplayString_fn& on_func);
        ...
        opt<id_t> register_ZwEnumerateDriverEntries                          (proc_t proc, const on_ZwEnumerateDriverEntries_fn& on_func);
        ...
        opt<id_t> register_ZwEnumerateValueKey                               (proc_t proc, const on_ZwEnumerateValueKey_fn& on_func);
        opt<id_t> register_NtExtendSection                                   (proc_t proc, const on_NtExtendSection_fn& on_func);
        opt<id_t> register_ZwFilterToken                                     (proc_t proc, const on_ZwFilterToken_fn& on_func);
        opt<id_t> register_ZwFindAtom                                        (proc_t proc, const on_ZwFindAtom_fn& on_func);
        ...
        opt<id_t> register_ZwFlushKey                                        (proc_t proc, const on_ZwFlushKey_fn& on_func);
        opt<id_t> register_ZwFlushVirtualMemory                              (proc_t proc, const on_ZwFlushVirtualMemory_fn& on_func);
        opt<id_t> register_ZwFreeUserPhysicalPages                           (proc_t proc, const on_ZwFreeUserPhysicalPages_fn& on_func);
        opt<id_t> register_ZwFreeVirtualMemory                               (proc_t proc, const on_ZwFreeVirtualMemory_fn& on_func);
        ...
        opt<id_t> register_ZwFsControlFile                                   (proc_t proc, const on_ZwFsControlFile_fn& on_func);
        opt<id_t> register_ZwGetContextThread                                (proc_t proc, const on_ZwGetContextThread_fn& on_func);
        opt<id_t> register_ZwGetDevicePowerState                             (proc_t proc, const on_ZwGetDevicePowerState_fn& on_func);
        opt<id_t> register_ZwGetMUIRegistryInfo                              (proc_t proc, const on_ZwGetMUIRegistryInfo_fn& on_func);
        ...
        opt<id_t> register_ZwGetNlsSectionPtr                                (proc_t proc, const on_ZwGetNlsSectionPtr_fn& on_func);
        opt<id_t> register_NtGetNotificationResourceManager                  (proc_t proc, const on_NtGetNotificationResourceManager_fn& on_func);
        opt<id_t> register_ZwGetWriteWatch                                   (proc_t proc, const on_ZwGetWriteWatch_fn& on_func);
        opt<id_t> register_ZwImpersonateAnonymousToken                       (proc_t proc, const on_ZwImpersonateAnonymousToken_fn& on_func);
        ...
        opt<id_t> register_ZwLoadDriver                                      (proc_t proc, const on_ZwLoadDriver_fn& on_func);
        opt<id_t> register_ZwLoadKey2                                        (proc_t proc, const on_ZwLoadKey2_fn& on_func);
        ...
        opt<id_t> register_ZwLockFile                                        (proc_t proc, const on_ZwLockFile_fn& on_func);
        opt<id_t> register_NtLockProductActivationKeys                       (proc_t proc, const on_NtLockProductActivationKeys_fn& on_func);
        opt<id_t> register_ZwLockRegistryKey                                 (proc_t proc, const on_ZwLockRegistryKey_fn& on_func);
        ...
        opt<id_t> register_ZwNotifyChangeKey                                 (proc_t proc, const on_ZwNotifyChangeKey_fn& on_func);
        ...
        opt<id_t> register_ZwOpenEventPair                                   (proc_t proc, const on_ZwOpenEventPair_fn& on_func);
        ...
        opt<id_t> register_ZwOpenKeyTransactedEx                             (proc_t proc, const on_ZwOpenKeyTransactedEx_fn& on_func);
        opt<id_t> register_ZwOpenKeyTransacted                               (proc_t proc, const on_ZwOpenKeyTransacted_fn& on_func);
        ...
        opt<id_t> register_ZwOpenSemaphore                                   (proc_t proc, const on_ZwOpenSemaphore_fn& on_func);
        opt<id_t> register_ZwOpenSession                                     (proc_t proc, const on_ZwOpenSession_fn& on_func);
        opt<id_t> register_ZwOpenSymbolicLinkObject                          (proc_t proc, const on_ZwOpenSymbolicLinkObject_fn& on_func);
        ...
        opt<id_t> register_ZwPlugPlayControl                                 (proc_t proc, const on_ZwPlugPlayControl_fn& on_func);
        opt<id_t> register_NtPowerInformation                                (proc_t proc, const on_NtPowerInformation_fn& on_func);
        opt<id_t> register_ZwPrepareComplete                                 (proc_t proc, const on_ZwPrepareComplete_fn& on_func);
        ...
        opt<id_t> register_ZwPrivilegedServiceAuditAlarm                     (proc_t proc, const on_ZwPrivilegedServiceAuditAlarm_fn& on_func);
        ...
        opt<id_t> register_ZwQueryDebugFilterState                           (proc_t proc, const on_ZwQueryDebugFilterState_fn& on_func);
        ...
        opt<id_t> register_ZwQueryInformationThread                          (proc_t proc, const on_ZwQueryInformationThread_fn& on_func);
        ...
        opt<id_t> register_ZwQueryLicenseValue                               (proc_t proc, const on_ZwQueryLicenseValue_fn& on_func);
        opt<id_t> register_ZwQueryMultipleValueKey                           (proc_t proc, const on_ZwQueryMultipleValueKey_fn& on_func);
        opt<id_t> register_ZwQueryMutant                                     (proc_t proc, const on_ZwQueryMutant_fn& on_func);
        opt<id_t> register_ZwQueryObject                                     (proc_t proc, const on_ZwQueryObject_fn& on_func);
        ...
        opt<id_t> register_ZwQuerySystemTime                                 (proc_t proc, const on_ZwQuerySystemTime_fn& on_func);
        opt<id_t> register_ZwQueryTimer                                      (proc_t proc, const on_ZwQueryTimer_fn& on_func);
        opt<id_t> register_ZwQueryTimerResolution                            (proc_t proc, const on_ZwQueryTimerResolution_fn& on_func);
        opt<id_t> register_NtQueryValueKey                                   (proc_t proc, const on_NtQueryValueKey_fn& on_func);
        opt<id_t> register_ZwQueryVirtualMemory                              (proc_t proc, const on_ZwQueryVirtualMemory_fn& on_func);
        opt<id_t> register_ZwQueryVolumeInformationFile                      (proc_t proc, const on_ZwQueryVolumeInformationFile_fn& on_func);
        ...
        opt<id_t> register_ZwReadFileScatter                                 (proc_t proc, const on_ZwReadFileScatter_fn& on_func);
        ...
        opt<id_t> register_ZwReadVirtualMemory                               (proc_t proc, const on_ZwReadVirtualMemory_fn& on_func);
        opt<id_t> register_ZwRecoverEnlistment                               (proc_t proc, const on_ZwRecoverEnlistment_fn& on_func);
        opt<id_t> register_ZwRecoverResourceManager                          (proc_t proc, const on_ZwRecoverResourceManager_fn& on_func);
        ...
        opt<id_t> register_ZwReleaseSemaphore                                (proc_t proc, const on_ZwReleaseSemaphore_fn& on_func);
        ...
        opt<id_t> register_ZwReplyWaitReceivePortEx                          (proc_t proc, const on_ZwReplyWaitReceivePortEx_fn& on_func);
        opt<id_t> register_ZwReplyWaitReceivePort                            (proc_t proc, const on_ZwReplyWaitReceivePort_fn& on_func);
        ...
        opt<id_t> register_ZwRequestWaitReplyPort                            (proc_t proc, const on_ZwRequestWaitReplyPort_fn& on_func);
        opt<id_t> register_ZwResetEvent                                      (proc_t proc, const on_ZwResetEvent_fn& on_func);
        ...
        opt<id_t> register_ZwRollbackTransaction                             (proc_t proc, const on_ZwRollbackTransaction_fn& on_func);
        ...
        opt<id_t> register_ZwSaveMergedKeys                                  (proc_t proc, const on_ZwSaveMergedKeys_fn& on_func);
        ...
        opt<id_t> register_ZwSetDebugFilterState                             (proc_t proc, const on_ZwSetDebugFilterState_fn& on_func);
        ...
        opt<id_t> register_ZwSetEventBoostPriority                           (proc_t proc, const on_ZwSetEventBoostPriority_fn& on_func);
        opt<id_t> register_ZwSetEvent                                        (proc_t proc, const on_ZwSetEvent_fn& on_func);
        opt<id_t> register_NtSetHighEventPair                                (proc_t proc, const on_NtSetHighEventPair_fn& on_func);
        opt<id_t> register_ZwSetHighWaitLowEventPair                         (proc_t proc, const on_ZwSetHighWaitLowEventPair_fn& on_func);
        ...
        opt<id_t> register_ZwSetIoCompletionEx                               (proc_t proc, const on_ZwSetIoCompletionEx_fn& on_func);
        opt<id_t> register_ZwSetIoCompletion                                 (proc_t proc, const on_ZwSetIoCompletion_fn& on_func);
        ...
        opt<id_t> register_ZwSetVolumeInformationFile                        (proc_t proc, const on_ZwSetVolumeInformationFile_fn& on_func);
        opt<id_t> register_ZwShutdownSystem                                  (proc_t proc, const on_ZwShutdownSystem_fn& on_func);
        opt<id_t> register_ZwShutdownWorkerFactory                           (proc_t proc, const on_ZwShutdownWorkerFactory_fn& on_func);
        ...
        opt<id_t> register_ZwStartProfile                                    (proc_t proc, const on_ZwStartProfile_fn& on_func);
        ...
        opt<id_t> register_ZwSystemDebugControl                              (proc_t proc, const on_ZwSystemDebugControl_fn& on_func);
        ...
        opt<id_t> register_ZwUnlockVirtualMemory                             (proc_t proc, const on_ZwUnlockVirtualMemory_fn& on_func);
        opt<id_t> register_NtUnmapViewOfSection                              (proc_t proc, const on_NtUnmapViewOfSection_fn& on_func);
        opt<id_t> register_ZwVdmControl                                      (proc_t proc, const on_ZwVdmControl_fn& on_func);
        opt<id_t> register_ZwWaitForDebugEvent                               (proc_t proc, const on_ZwWaitForDebugEvent_fn& on_func);
        opt<id_t> register_NtWaitForKeyedEvent                               (proc_t proc, const on_NtWaitForKeyedEvent_fn& on_func);
        opt<id_t> register_ZwWaitForMultipleObjects32                        (proc_t proc, const on_ZwWaitForMultipleObjects32_fn& on_func);
        ...
        opt<id_t> register_ZwWaitForWorkViaWorkerFactory                     (proc_t proc, const on_ZwWaitForWorkViaWorkerFactory_fn& on_func);
        ...
        opt<id_t> register_ZwWriteFileGather                                 (proc_t proc, const on_ZwWriteFileGather_fn& on_func);
        opt<id_t> register_NtWriteFile                                       (proc_t proc, const on_NtWriteFile_fn& on_func);
        opt<id_t> register_ZwWriteRequestData                                (proc_t proc, const on_ZwWriteRequestData_fn& on_func);
        ...
        opt<id_t> register_ZwGetCurrentProcessorNumber                       (proc_t proc, const on_ZwGetCurrentProcessorNumber_fn& on_func);
        opt<id_t> register_ZwIsSystemResumeAutomatic                         (proc_t proc, const on_ZwIsSystemResumeAutomatic_fn& on_func);
        ...
        opt<id_t> register_ZwSerializeBoot                                   (proc_t proc, const on_ZwSerializeBoot_fn& on_func);
        opt<id_t> register_ZwTestAlert                                       (proc_t proc, const on_ZwTestAlert_fn& on_func);
        opt<id_t> register_ZwThawRegistry                                    (proc_t proc, const on_ZwThawRegistry_fn& on_func);
        opt<id_t> register_ZwThawTransactions                                (proc_t proc, const on_ZwThawTransactions_fn& on_func);
