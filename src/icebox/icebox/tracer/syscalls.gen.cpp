...
nt::syscalls::Data::Data(core::Core& core, sym::Symbols& syms, std::string_view module)
    : core(core)
    , syms(syms)
    , module(module)
    , last_id(0)
...
nt::syscalls::syscalls(core::Core& core, sym::Symbols& syms, std::string_view module)
...
namespace
{
    static opt<bpid_t> register_callback(nt::syscalls::Data& d, bpid_t id, proc_t proc, const char* name, const core::Task& on_call)
    {
