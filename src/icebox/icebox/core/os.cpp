...
{
    return core.d_->os_->is_kernel_address(ptr);
}
...
bool os::can_inject_fault(core::Core& core, uint64_t ptr)
{
    ...
    return core.d_->os_->can_inject_fault(ptr);
}
