...
#define DECLARE_HANDLERS\
    {"NtAcceptConnectPort", &syscall_mon::SyscallMonitor::on_NtAcceptConnectPort},\
    {"NtAccessCheckAndAuditAlarm", &syscall_mon::SyscallMonitor::on_NtAccessCheckAndAuditAlarm},\
    {"NtAccessCheckByTypeAndAuditAlarm", &syscall_mon::SyscallMonitor::on_NtAccessCheckByTypeAndAuditAlarm},\
    {"NtAccessCheckByType", &syscall_mon::SyscallMonitor::on_NtAccessCheckByType},\
    {"NtAccessCheckByTypeResultListAndAuditAlarmByHandle", &syscall_mon::SyscallMonitor::on_NtAccessCheckByTypeResultListAndAuditAlarmByHandle},\
    {"NtAccessCheckByTypeResultListAndAuditAlarm", &syscall_mon::SyscallMonitor::on_NtAccessCheckByTypeResultListAndAuditAlarm},\
    {"NtAccessCheckByTypeResultList", &syscall_mon::SyscallMonitor::on_NtAccessCheckByTypeResultList},\
    {"NtAccessCheck", &syscall_mon::SyscallMonitor::on_NtAccessCheck},\
    {"NtAddAtom", &syscall_mon::SyscallMonitor::on_NtAddAtom},\
    {"NtAddBootEntry", &syscall_mon::SyscallMonitor::on_NtAddBootEntry},\
    {"NtAddDriverEntry", &syscall_mon::SyscallMonitor::on_NtAddDriverEntry},\
    {"NtAdjustGroupsToken", &syscall_mon::SyscallMonitor::on_NtAdjustGroupsToken},\
    {"NtAdjustPrivilegesToken", &syscall_mon::SyscallMonitor::on_NtAdjustPrivilegesToken},\
    {"NtAlertResumeThread", &syscall_mon::SyscallMonitor::on_NtAlertResumeThread},\
    {"NtAlertThread", &syscall_mon::SyscallMonitor::on_NtAlertThread},\
    {"NtAllocateLocallyUniqueId", &syscall_mon::SyscallMonitor::on_NtAllocateLocallyUniqueId},\
    {"NtAllocateReserveObject", &syscall_mon::SyscallMonitor::on_NtAllocateReserveObject},\
    {"NtAllocateUserPhysicalPages", &syscall_mon::SyscallMonitor::on_NtAllocateUserPhysicalPages},\
    {"NtAllocateUuids", &syscall_mon::SyscallMonitor::on_NtAllocateUuids},\
    {"NtAllocateVirtualMemory", &syscall_mon::SyscallMonitor::on_NtAllocateVirtualMemory},\
    {"NtAlpcAcceptConnectPort", &syscall_mon::SyscallMonitor::on_NtAlpcAcceptConnectPort},\
    {"NtAlpcCancelMessage", &syscall_mon::SyscallMonitor::on_NtAlpcCancelMessage},\
    {"NtAlpcConnectPort", &syscall_mon::SyscallMonitor::on_NtAlpcConnectPort},\
    {"NtAlpcCreatePort", &syscall_mon::SyscallMonitor::on_NtAlpcCreatePort},\
    {"NtAlpcCreatePortSection", &syscall_mon::SyscallMonitor::on_NtAlpcCreatePortSection},\
    {"NtAlpcCreateResourceReserve", &syscall_mon::SyscallMonitor::on_NtAlpcCreateResourceReserve},\
    {"NtAlpcCreateSectionView", &syscall_mon::SyscallMonitor::on_NtAlpcCreateSectionView},\
    {"NtAlpcCreateSecurityContext", &syscall_mon::SyscallMonitor::on_NtAlpcCreateSecurityContext},\
    {"NtAlpcDeletePortSection", &syscall_mon::SyscallMonitor::on_NtAlpcDeletePortSection},\
    {"NtAlpcDeleteResourceReserve", &syscall_mon::SyscallMonitor::on_NtAlpcDeleteResourceReserve},\
    {"NtAlpcDeleteSectionView", &syscall_mon::SyscallMonitor::on_NtAlpcDeleteSectionView},\
    {"NtAlpcDeleteSecurityContext", &syscall_mon::SyscallMonitor::on_NtAlpcDeleteSecurityContext},\
    {"NtAlpcDisconnectPort", &syscall_mon::SyscallMonitor::on_NtAlpcDisconnectPort},\
    {"NtAlpcImpersonateClientOfPort", &syscall_mon::SyscallMonitor::on_NtAlpcImpersonateClientOfPort},\
    {"NtAlpcOpenSenderProcess", &syscall_mon::SyscallMonitor::on_NtAlpcOpenSenderProcess},\
    {"NtAlpcOpenSenderThread", &syscall_mon::SyscallMonitor::on_NtAlpcOpenSenderThread},\
    {"NtAlpcQueryInformation", &syscall_mon::SyscallMonitor::on_NtAlpcQueryInformation},\
    {"NtAlpcQueryInformationMessage", &syscall_mon::SyscallMonitor::on_NtAlpcQueryInformationMessage},\
    {"NtAlpcRevokeSecurityContext", &syscall_mon::SyscallMonitor::on_NtAlpcRevokeSecurityContext},\
    {"NtAlpcSendWaitReceivePort", &syscall_mon::SyscallMonitor::on_NtAlpcSendWaitReceivePort},\
    {"NtAlpcSetInformation", &syscall_mon::SyscallMonitor::on_NtAlpcSetInformation},\
    {"NtApphelpCacheControl", &syscall_mon::SyscallMonitor::on_NtApphelpCacheControl},\
    {"NtAreMappedFilesTheSame", &syscall_mon::SyscallMonitor::on_NtAreMappedFilesTheSame},\
    {"NtAssignProcessToJobObject", &syscall_mon::SyscallMonitor::on_NtAssignProcessToJobObject},\
    {"NtCallbackReturn", &syscall_mon::SyscallMonitor::on_NtCallbackReturn},\
    {"NtCancelIoFileEx", &syscall_mon::SyscallMonitor::on_NtCancelIoFileEx},\
    {"NtCancelIoFile", &syscall_mon::SyscallMonitor::on_NtCancelIoFile},\
    {"NtCancelSynchronousIoFile", &syscall_mon::SyscallMonitor::on_NtCancelSynchronousIoFile},\
    {"NtCancelTimer", &syscall_mon::SyscallMonitor::on_NtCancelTimer},\
    {"NtClearEvent", &syscall_mon::SyscallMonitor::on_NtClearEvent},\
    {"NtClose", &syscall_mon::SyscallMonitor::on_NtClose},\
    {"NtCloseObjectAuditAlarm", &syscall_mon::SyscallMonitor::on_NtCloseObjectAuditAlarm},\
    {"NtCommitComplete", &syscall_mon::SyscallMonitor::on_NtCommitComplete},\
    {"NtCommitEnlistment", &syscall_mon::SyscallMonitor::on_NtCommitEnlistment},\
    {"NtCommitTransaction", &syscall_mon::SyscallMonitor::on_NtCommitTransaction},\
    {"NtCompactKeys", &syscall_mon::SyscallMonitor::on_NtCompactKeys},\
    {"NtCompareTokens", &syscall_mon::SyscallMonitor::on_NtCompareTokens},\
    {"NtCompleteConnectPort", &syscall_mon::SyscallMonitor::on_NtCompleteConnectPort},\
    {"NtCompressKey", &syscall_mon::SyscallMonitor::on_NtCompressKey},\
    {"NtConnectPort", &syscall_mon::SyscallMonitor::on_NtConnectPort},\
    {"NtContinue", &syscall_mon::SyscallMonitor::on_NtContinue},\
    {"NtCreateDebugObject", &syscall_mon::SyscallMonitor::on_NtCreateDebugObject},\
    {"NtCreateDirectoryObject", &syscall_mon::SyscallMonitor::on_NtCreateDirectoryObject},\
    {"NtCreateEnlistment", &syscall_mon::SyscallMonitor::on_NtCreateEnlistment},\
    {"NtCreateEvent", &syscall_mon::SyscallMonitor::on_NtCreateEvent},\
    {"NtCreateEventPair", &syscall_mon::SyscallMonitor::on_NtCreateEventPair},\
    {"NtCreateFile", &syscall_mon::SyscallMonitor::on_NtCreateFile},\
    {"NtCreateIoCompletion", &syscall_mon::SyscallMonitor::on_NtCreateIoCompletion},\
    {"NtCreateJobObject", &syscall_mon::SyscallMonitor::on_NtCreateJobObject},\
    {"NtCreateJobSet", &syscall_mon::SyscallMonitor::on_NtCreateJobSet},\
    {"NtCreateKeyedEvent", &syscall_mon::SyscallMonitor::on_NtCreateKeyedEvent},\
    {"NtCreateKey", &syscall_mon::SyscallMonitor::on_NtCreateKey},\
    {"NtCreateKeyTransacted", &syscall_mon::SyscallMonitor::on_NtCreateKeyTransacted},\
    {"NtCreateMailslotFile", &syscall_mon::SyscallMonitor::on_NtCreateMailslotFile},\
    {"NtCreateMutant", &syscall_mon::SyscallMonitor::on_NtCreateMutant},\
    {"NtCreateNamedPipeFile", &syscall_mon::SyscallMonitor::on_NtCreateNamedPipeFile},\
    {"NtCreatePagingFile", &syscall_mon::SyscallMonitor::on_NtCreatePagingFile},\
    {"NtCreatePort", &syscall_mon::SyscallMonitor::on_NtCreatePort},\
    {"NtCreatePrivateNamespace", &syscall_mon::SyscallMonitor::on_NtCreatePrivateNamespace},\
    {"NtCreateProcessEx", &syscall_mon::SyscallMonitor::on_NtCreateProcessEx},\
    {"NtCreateProcess", &syscall_mon::SyscallMonitor::on_NtCreateProcess},\
    {"NtCreateProfileEx", &syscall_mon::SyscallMonitor::on_NtCreateProfileEx},\
    {"NtCreateProfile", &syscall_mon::SyscallMonitor::on_NtCreateProfile},\
    {"NtCreateResourceManager", &syscall_mon::SyscallMonitor::on_NtCreateResourceManager},\
    {"NtCreateSection", &syscall_mon::SyscallMonitor::on_NtCreateSection},\
    {"NtCreateSemaphore", &syscall_mon::SyscallMonitor::on_NtCreateSemaphore},\
    {"NtCreateSymbolicLinkObject", &syscall_mon::SyscallMonitor::on_NtCreateSymbolicLinkObject},\
    {"NtCreateThreadEx", &syscall_mon::SyscallMonitor::on_NtCreateThreadEx},\
    {"NtCreateThread", &syscall_mon::SyscallMonitor::on_NtCreateThread},\
    {"NtCreateTimer", &syscall_mon::SyscallMonitor::on_NtCreateTimer},\
    {"NtCreateToken", &syscall_mon::SyscallMonitor::on_NtCreateToken},\
    {"NtCreateTransactionManager", &syscall_mon::SyscallMonitor::on_NtCreateTransactionManager},\
    {"NtCreateTransaction", &syscall_mon::SyscallMonitor::on_NtCreateTransaction},\
    {"NtCreateUserProcess", &syscall_mon::SyscallMonitor::on_NtCreateUserProcess},\
    {"NtCreateWaitablePort", &syscall_mon::SyscallMonitor::on_NtCreateWaitablePort},\
    {"NtCreateWorkerFactory", &syscall_mon::SyscallMonitor::on_NtCreateWorkerFactory},\
    {"NtDebugActiveProcess", &syscall_mon::SyscallMonitor::on_NtDebugActiveProcess},\
    {"NtDebugContinue", &syscall_mon::SyscallMonitor::on_NtDebugContinue},\
    {"NtDelayExecution", &syscall_mon::SyscallMonitor::on_NtDelayExecution},\
    {"NtDeleteAtom", &syscall_mon::SyscallMonitor::on_NtDeleteAtom},\
    {"NtDeleteBootEntry", &syscall_mon::SyscallMonitor::on_NtDeleteBootEntry},\
    {"NtDeleteDriverEntry", &syscall_mon::SyscallMonitor::on_NtDeleteDriverEntry},\
    {"NtDeleteFile", &syscall_mon::SyscallMonitor::on_NtDeleteFile},\
    {"NtDeleteKey", &syscall_mon::SyscallMonitor::on_NtDeleteKey},\
    {"NtDeleteObjectAuditAlarm", &syscall_mon::SyscallMonitor::on_NtDeleteObjectAuditAlarm},\
    {"NtDeletePrivateNamespace", &syscall_mon::SyscallMonitor::on_NtDeletePrivateNamespace},\
    {"NtDeleteValueKey", &syscall_mon::SyscallMonitor::on_NtDeleteValueKey},\
    {"NtDeviceIoControlFile", &syscall_mon::SyscallMonitor::on_NtDeviceIoControlFile},\
    {"NtDisplayString", &syscall_mon::SyscallMonitor::on_NtDisplayString},\
    {"NtDrawText", &syscall_mon::SyscallMonitor::on_NtDrawText},\
    {"NtDuplicateObject", &syscall_mon::SyscallMonitor::on_NtDuplicateObject},\
    {"NtDuplicateToken", &syscall_mon::SyscallMonitor::on_NtDuplicateToken},\
    {"NtEnumerateBootEntries", &syscall_mon::SyscallMonitor::on_NtEnumerateBootEntries},\
    {"NtEnumerateDriverEntries", &syscall_mon::SyscallMonitor::on_NtEnumerateDriverEntries},\
    {"NtEnumerateKey", &syscall_mon::SyscallMonitor::on_NtEnumerateKey},\
    {"NtEnumerateSystemEnvironmentValuesEx", &syscall_mon::SyscallMonitor::on_NtEnumerateSystemEnvironmentValuesEx},\
    {"NtEnumerateTransactionObject", &syscall_mon::SyscallMonitor::on_NtEnumerateTransactionObject},\
    {"NtEnumerateValueKey", &syscall_mon::SyscallMonitor::on_NtEnumerateValueKey},\
    {"NtExtendSection", &syscall_mon::SyscallMonitor::on_NtExtendSection},\
    {"NtFilterToken", &syscall_mon::SyscallMonitor::on_NtFilterToken},\
    {"NtFindAtom", &syscall_mon::SyscallMonitor::on_NtFindAtom},\
    {"NtFlushBuffersFile", &syscall_mon::SyscallMonitor::on_NtFlushBuffersFile},\
    {"NtFlushInstallUILanguage", &syscall_mon::SyscallMonitor::on_NtFlushInstallUILanguage},\
    {"NtFlushInstructionCache", &syscall_mon::SyscallMonitor::on_NtFlushInstructionCache},\
    {"NtFlushKey", &syscall_mon::SyscallMonitor::on_NtFlushKey},\
    {"NtFlushVirtualMemory", &syscall_mon::SyscallMonitor::on_NtFlushVirtualMemory},\
    {"NtFreeUserPhysicalPages", &syscall_mon::SyscallMonitor::on_NtFreeUserPhysicalPages},\
    {"NtFreeVirtualMemory", &syscall_mon::SyscallMonitor::on_NtFreeVirtualMemory},\
    {"NtFreezeRegistry", &syscall_mon::SyscallMonitor::on_NtFreezeRegistry},\
    {"NtFreezeTransactions", &syscall_mon::SyscallMonitor::on_NtFreezeTransactions},\
    {"NtFsControlFile", &syscall_mon::SyscallMonitor::on_NtFsControlFile},\
    {"NtGetContextThread", &syscall_mon::SyscallMonitor::on_NtGetContextThread},\
    {"NtGetDevicePowerState", &syscall_mon::SyscallMonitor::on_NtGetDevicePowerState},\
    {"NtGetMUIRegistryInfo", &syscall_mon::SyscallMonitor::on_NtGetMUIRegistryInfo},\
    {"NtGetNextProcess", &syscall_mon::SyscallMonitor::on_NtGetNextProcess},\
    {"NtGetNextThread", &syscall_mon::SyscallMonitor::on_NtGetNextThread},\
    {"NtGetNlsSectionPtr", &syscall_mon::SyscallMonitor::on_NtGetNlsSectionPtr},\
    {"NtGetNotificationResourceManager", &syscall_mon::SyscallMonitor::on_NtGetNotificationResourceManager},\
    {"NtGetPlugPlayEvent", &syscall_mon::SyscallMonitor::on_NtGetPlugPlayEvent},\
    {"NtGetWriteWatch", &syscall_mon::SyscallMonitor::on_NtGetWriteWatch},\
    {"NtImpersonateAnonymousToken", &syscall_mon::SyscallMonitor::on_NtImpersonateAnonymousToken},\
    {"NtImpersonateClientOfPort", &syscall_mon::SyscallMonitor::on_NtImpersonateClientOfPort},\
    {"NtImpersonateThread", &syscall_mon::SyscallMonitor::on_NtImpersonateThread},\
    {"NtInitializeNlsFiles", &syscall_mon::SyscallMonitor::on_NtInitializeNlsFiles},\
    {"NtInitializeRegistry", &syscall_mon::SyscallMonitor::on_NtInitializeRegistry},\
    {"NtInitiatePowerAction", &syscall_mon::SyscallMonitor::on_NtInitiatePowerAction},\
    {"NtIsProcessInJob", &syscall_mon::SyscallMonitor::on_NtIsProcessInJob},\
    {"NtListenPort", &syscall_mon::SyscallMonitor::on_NtListenPort},\
    {"NtLoadDriver", &syscall_mon::SyscallMonitor::on_NtLoadDriver},\
    {"NtLoadKey2", &syscall_mon::SyscallMonitor::on_NtLoadKey2},\
    {"NtLoadKeyEx", &syscall_mon::SyscallMonitor::on_NtLoadKeyEx},\
    {"NtLoadKey", &syscall_mon::SyscallMonitor::on_NtLoadKey},\
    {"NtLockFile", &syscall_mon::SyscallMonitor::on_NtLockFile},\
    {"NtLockProductActivationKeys", &syscall_mon::SyscallMonitor::on_NtLockProductActivationKeys},\
    {"NtLockRegistryKey", &syscall_mon::SyscallMonitor::on_NtLockRegistryKey},\
    {"NtLockVirtualMemory", &syscall_mon::SyscallMonitor::on_NtLockVirtualMemory},\
    {"NtMakePermanentObject", &syscall_mon::SyscallMonitor::on_NtMakePermanentObject},\
    {"NtMakeTemporaryObject", &syscall_mon::SyscallMonitor::on_NtMakeTemporaryObject},\
    {"NtMapCMFModule", &syscall_mon::SyscallMonitor::on_NtMapCMFModule},\
    {"NtMapUserPhysicalPages", &syscall_mon::SyscallMonitor::on_NtMapUserPhysicalPages},\
    {"NtMapUserPhysicalPagesScatter", &syscall_mon::SyscallMonitor::on_NtMapUserPhysicalPagesScatter},\
    {"NtMapViewOfSection", &syscall_mon::SyscallMonitor::on_NtMapViewOfSection},\
    {"NtModifyBootEntry", &syscall_mon::SyscallMonitor::on_NtModifyBootEntry},\
    {"NtModifyDriverEntry", &syscall_mon::SyscallMonitor::on_NtModifyDriverEntry},\
    {"NtNotifyChangeDirectoryFile", &syscall_mon::SyscallMonitor::on_NtNotifyChangeDirectoryFile},\
    {"NtNotifyChangeKey", &syscall_mon::SyscallMonitor::on_NtNotifyChangeKey},\
    {"NtNotifyChangeMultipleKeys", &syscall_mon::SyscallMonitor::on_NtNotifyChangeMultipleKeys},\
    {"NtNotifyChangeSession", &syscall_mon::SyscallMonitor::on_NtNotifyChangeSession},\
    {"NtOpenDirectoryObject", &syscall_mon::SyscallMonitor::on_NtOpenDirectoryObject},\
    {"NtOpenEnlistment", &syscall_mon::SyscallMonitor::on_NtOpenEnlistment},\
    {"NtOpenEvent", &syscall_mon::SyscallMonitor::on_NtOpenEvent},\
    {"NtOpenEventPair", &syscall_mon::SyscallMonitor::on_NtOpenEventPair},\
    {"NtOpenFile", &syscall_mon::SyscallMonitor::on_NtOpenFile},\
    {"NtOpenIoCompletion", &syscall_mon::SyscallMonitor::on_NtOpenIoCompletion},\
    {"NtOpenJobObject", &syscall_mon::SyscallMonitor::on_NtOpenJobObject},\
    {"NtOpenKeyedEvent", &syscall_mon::SyscallMonitor::on_NtOpenKeyedEvent},\
    {"NtOpenKeyEx", &syscall_mon::SyscallMonitor::on_NtOpenKeyEx},\
    {"NtOpenKey", &syscall_mon::SyscallMonitor::on_NtOpenKey},\
    {"NtOpenKeyTransactedEx", &syscall_mon::SyscallMonitor::on_NtOpenKeyTransactedEx},\
    {"NtOpenKeyTransacted", &syscall_mon::SyscallMonitor::on_NtOpenKeyTransacted},\
    {"NtOpenMutant", &syscall_mon::SyscallMonitor::on_NtOpenMutant},\
    {"NtOpenObjectAuditAlarm", &syscall_mon::SyscallMonitor::on_NtOpenObjectAuditAlarm},\
    {"NtOpenPrivateNamespace", &syscall_mon::SyscallMonitor::on_NtOpenPrivateNamespace},\
    {"NtOpenProcess", &syscall_mon::SyscallMonitor::on_NtOpenProcess},\
    {"NtOpenProcessTokenEx", &syscall_mon::SyscallMonitor::on_NtOpenProcessTokenEx},\
    {"NtOpenProcessToken", &syscall_mon::SyscallMonitor::on_NtOpenProcessToken},\
    {"NtOpenResourceManager", &syscall_mon::SyscallMonitor::on_NtOpenResourceManager},\
    {"NtOpenSection", &syscall_mon::SyscallMonitor::on_NtOpenSection},\
    {"NtOpenSemaphore", &syscall_mon::SyscallMonitor::on_NtOpenSemaphore},\
    {"NtOpenSession", &syscall_mon::SyscallMonitor::on_NtOpenSession},\
    {"NtOpenSymbolicLinkObject", &syscall_mon::SyscallMonitor::on_NtOpenSymbolicLinkObject},\
    {"NtOpenThread", &syscall_mon::SyscallMonitor::on_NtOpenThread},\
    {"NtOpenThreadTokenEx", &syscall_mon::SyscallMonitor::on_NtOpenThreadTokenEx},\
    {"NtOpenThreadToken", &syscall_mon::SyscallMonitor::on_NtOpenThreadToken},\
    {"NtOpenTimer", &syscall_mon::SyscallMonitor::on_NtOpenTimer},\
    {"NtOpenTransactionManager", &syscall_mon::SyscallMonitor::on_NtOpenTransactionManager},\
    {"NtOpenTransaction", &syscall_mon::SyscallMonitor::on_NtOpenTransaction},\
    {"NtPlugPlayControl", &syscall_mon::SyscallMonitor::on_NtPlugPlayControl},\
    {"NtPowerInformation", &syscall_mon::SyscallMonitor::on_NtPowerInformation},\
    {"NtPrepareComplete", &syscall_mon::SyscallMonitor::on_NtPrepareComplete},\
    {"NtPrepareEnlistment", &syscall_mon::SyscallMonitor::on_NtPrepareEnlistment},\
    {"NtPrePrepareComplete", &syscall_mon::SyscallMonitor::on_NtPrePrepareComplete},\
    {"NtPrePrepareEnlistment", &syscall_mon::SyscallMonitor::on_NtPrePrepareEnlistment},\
    {"NtPrivilegeCheck", &syscall_mon::SyscallMonitor::on_NtPrivilegeCheck},\
    {"NtPrivilegedServiceAuditAlarm", &syscall_mon::SyscallMonitor::on_NtPrivilegedServiceAuditAlarm},\
    {"NtPrivilegeObjectAuditAlarm", &syscall_mon::SyscallMonitor::on_NtPrivilegeObjectAuditAlarm},\
    {"NtPropagationComplete", &syscall_mon::SyscallMonitor::on_NtPropagationComplete},\
    {"NtPropagationFailed", &syscall_mon::SyscallMonitor::on_NtPropagationFailed},\
    {"NtProtectVirtualMemory", &syscall_mon::SyscallMonitor::on_NtProtectVirtualMemory},\
    {"NtPulseEvent", &syscall_mon::SyscallMonitor::on_NtPulseEvent},\
    {"NtQueryAttributesFile", &syscall_mon::SyscallMonitor::on_NtQueryAttributesFile},\
    {"NtQueryBootEntryOrder", &syscall_mon::SyscallMonitor::on_NtQueryBootEntryOrder},\
    {"NtQueryBootOptions", &syscall_mon::SyscallMonitor::on_NtQueryBootOptions},\
    {"NtQueryDebugFilterState", &syscall_mon::SyscallMonitor::on_NtQueryDebugFilterState},\
    {"NtQueryDefaultLocale", &syscall_mon::SyscallMonitor::on_NtQueryDefaultLocale},\
    {"NtQueryDefaultUILanguage", &syscall_mon::SyscallMonitor::on_NtQueryDefaultUILanguage},\
    {"NtQueryDirectoryFile", &syscall_mon::SyscallMonitor::on_NtQueryDirectoryFile},\
    {"NtQueryDirectoryObject", &syscall_mon::SyscallMonitor::on_NtQueryDirectoryObject},\
    {"NtQueryDriverEntryOrder", &syscall_mon::SyscallMonitor::on_NtQueryDriverEntryOrder},\
    {"NtQueryEaFile", &syscall_mon::SyscallMonitor::on_NtQueryEaFile},\
    {"NtQueryEvent", &syscall_mon::SyscallMonitor::on_NtQueryEvent},\
    {"NtQueryFullAttributesFile", &syscall_mon::SyscallMonitor::on_NtQueryFullAttributesFile},\
    {"NtQueryInformationAtom", &syscall_mon::SyscallMonitor::on_NtQueryInformationAtom},\
    {"NtQueryInformationEnlistment", &syscall_mon::SyscallMonitor::on_NtQueryInformationEnlistment},\
    {"NtQueryInformationFile", &syscall_mon::SyscallMonitor::on_NtQueryInformationFile},\
    {"NtQueryInformationJobObject", &syscall_mon::SyscallMonitor::on_NtQueryInformationJobObject},\
    {"NtQueryInformationPort", &syscall_mon::SyscallMonitor::on_NtQueryInformationPort},\
    {"NtQueryInformationProcess", &syscall_mon::SyscallMonitor::on_NtQueryInformationProcess},\
    {"NtQueryInformationResourceManager", &syscall_mon::SyscallMonitor::on_NtQueryInformationResourceManager},\
    {"NtQueryInformationThread", &syscall_mon::SyscallMonitor::on_NtQueryInformationThread},\
    {"NtQueryInformationToken", &syscall_mon::SyscallMonitor::on_NtQueryInformationToken},\
    {"NtQueryInformationTransaction", &syscall_mon::SyscallMonitor::on_NtQueryInformationTransaction},\
    {"NtQueryInformationTransactionManager", &syscall_mon::SyscallMonitor::on_NtQueryInformationTransactionManager},\
    {"NtQueryInformationWorkerFactory", &syscall_mon::SyscallMonitor::on_NtQueryInformationWorkerFactory},\
    {"NtQueryInstallUILanguage", &syscall_mon::SyscallMonitor::on_NtQueryInstallUILanguage},\
    {"NtQueryIntervalProfile", &syscall_mon::SyscallMonitor::on_NtQueryIntervalProfile},\
    {"NtQueryIoCompletion", &syscall_mon::SyscallMonitor::on_NtQueryIoCompletion},\
    {"NtQueryKey", &syscall_mon::SyscallMonitor::on_NtQueryKey},\
    {"NtQueryLicenseValue", &syscall_mon::SyscallMonitor::on_NtQueryLicenseValue},\
    {"NtQueryMultipleValueKey", &syscall_mon::SyscallMonitor::on_NtQueryMultipleValueKey},\
    {"NtQueryMutant", &syscall_mon::SyscallMonitor::on_NtQueryMutant},\
    {"NtQueryObject", &syscall_mon::SyscallMonitor::on_NtQueryObject},\
    {"NtQueryOpenSubKeysEx", &syscall_mon::SyscallMonitor::on_NtQueryOpenSubKeysEx},\
    {"NtQueryOpenSubKeys", &syscall_mon::SyscallMonitor::on_NtQueryOpenSubKeys},\
    {"NtQueryPerformanceCounter", &syscall_mon::SyscallMonitor::on_NtQueryPerformanceCounter},\
    {"NtQueryQuotaInformationFile", &syscall_mon::SyscallMonitor::on_NtQueryQuotaInformationFile},\
    {"NtQuerySection", &syscall_mon::SyscallMonitor::on_NtQuerySection},\
    {"NtQuerySecurityAttributesToken", &syscall_mon::SyscallMonitor::on_NtQuerySecurityAttributesToken},\
    {"NtQuerySecurityObject", &syscall_mon::SyscallMonitor::on_NtQuerySecurityObject},\
    {"NtQuerySemaphore", &syscall_mon::SyscallMonitor::on_NtQuerySemaphore},\
    {"NtQuerySymbolicLinkObject", &syscall_mon::SyscallMonitor::on_NtQuerySymbolicLinkObject},\
    {"NtQuerySystemEnvironmentValueEx", &syscall_mon::SyscallMonitor::on_NtQuerySystemEnvironmentValueEx},\
    {"NtQuerySystemEnvironmentValue", &syscall_mon::SyscallMonitor::on_NtQuerySystemEnvironmentValue},\
    {"NtQuerySystemInformationEx", &syscall_mon::SyscallMonitor::on_NtQuerySystemInformationEx},\
    {"NtQuerySystemInformation", &syscall_mon::SyscallMonitor::on_NtQuerySystemInformation},\
    {"NtQuerySystemTime", &syscall_mon::SyscallMonitor::on_NtQuerySystemTime},\
    {"NtQueryTimer", &syscall_mon::SyscallMonitor::on_NtQueryTimer},\
    {"NtQueryTimerResolution", &syscall_mon::SyscallMonitor::on_NtQueryTimerResolution},\
    {"NtQueryValueKey", &syscall_mon::SyscallMonitor::on_NtQueryValueKey},\
    {"NtQueryVirtualMemory", &syscall_mon::SyscallMonitor::on_NtQueryVirtualMemory},\
    {"NtQueryVolumeInformationFile", &syscall_mon::SyscallMonitor::on_NtQueryVolumeInformationFile},\
    {"NtQueueApcThreadEx", &syscall_mon::SyscallMonitor::on_NtQueueApcThreadEx},\
    {"NtQueueApcThread", &syscall_mon::SyscallMonitor::on_NtQueueApcThread},\
    {"NtRaiseException", &syscall_mon::SyscallMonitor::on_NtRaiseException},\
    {"NtRaiseHardError", &syscall_mon::SyscallMonitor::on_NtRaiseHardError},\
    {"NtReadFile", &syscall_mon::SyscallMonitor::on_NtReadFile},\
    {"NtReadFileScatter", &syscall_mon::SyscallMonitor::on_NtReadFileScatter},\
    {"NtReadOnlyEnlistment", &syscall_mon::SyscallMonitor::on_NtReadOnlyEnlistment},\
    {"NtReadRequestData", &syscall_mon::SyscallMonitor::on_NtReadRequestData},\
    {"NtReadVirtualMemory", &syscall_mon::SyscallMonitor::on_NtReadVirtualMemory},\
    {"NtRecoverEnlistment", &syscall_mon::SyscallMonitor::on_NtRecoverEnlistment},\
    {"NtRecoverResourceManager", &syscall_mon::SyscallMonitor::on_NtRecoverResourceManager},\
    {"NtRecoverTransactionManager", &syscall_mon::SyscallMonitor::on_NtRecoverTransactionManager},\
    {"NtRegisterProtocolAddressInformation", &syscall_mon::SyscallMonitor::on_NtRegisterProtocolAddressInformation},\
    {"NtRegisterThreadTerminatePort", &syscall_mon::SyscallMonitor::on_NtRegisterThreadTerminatePort},\
    {"NtReleaseKeyedEvent", &syscall_mon::SyscallMonitor::on_NtReleaseKeyedEvent},\
    {"NtReleaseMutant", &syscall_mon::SyscallMonitor::on_NtReleaseMutant},\
    {"NtReleaseSemaphore", &syscall_mon::SyscallMonitor::on_NtReleaseSemaphore},\
    {"NtReleaseWorkerFactoryWorker", &syscall_mon::SyscallMonitor::on_NtReleaseWorkerFactoryWorker},\
    {"NtRemoveIoCompletionEx", &syscall_mon::SyscallMonitor::on_NtRemoveIoCompletionEx},\
    {"NtRemoveIoCompletion", &syscall_mon::SyscallMonitor::on_NtRemoveIoCompletion},\
    {"NtRemoveProcessDebug", &syscall_mon::SyscallMonitor::on_NtRemoveProcessDebug},\
    {"NtRenameKey", &syscall_mon::SyscallMonitor::on_NtRenameKey},\
    {"NtRenameTransactionManager", &syscall_mon::SyscallMonitor::on_NtRenameTransactionManager},\
    {"NtReplaceKey", &syscall_mon::SyscallMonitor::on_NtReplaceKey},\
    {"NtReplacePartitionUnit", &syscall_mon::SyscallMonitor::on_NtReplacePartitionUnit},\
    {"NtReplyPort", &syscall_mon::SyscallMonitor::on_NtReplyPort},\
    {"NtReplyWaitReceivePortEx", &syscall_mon::SyscallMonitor::on_NtReplyWaitReceivePortEx},\
    {"NtReplyWaitReceivePort", &syscall_mon::SyscallMonitor::on_NtReplyWaitReceivePort},\
    {"NtReplyWaitReplyPort", &syscall_mon::SyscallMonitor::on_NtReplyWaitReplyPort},\
    {"NtRequestPort", &syscall_mon::SyscallMonitor::on_NtRequestPort},\
    {"NtRequestWaitReplyPort", &syscall_mon::SyscallMonitor::on_NtRequestWaitReplyPort},\
    {"NtResetEvent", &syscall_mon::SyscallMonitor::on_NtResetEvent},\
    {"NtResetWriteWatch", &syscall_mon::SyscallMonitor::on_NtResetWriteWatch},\
    {"NtRestoreKey", &syscall_mon::SyscallMonitor::on_NtRestoreKey},\
    {"NtResumeProcess", &syscall_mon::SyscallMonitor::on_NtResumeProcess},\
    {"NtResumeThread", &syscall_mon::SyscallMonitor::on_NtResumeThread},\
    {"NtRollbackComplete", &syscall_mon::SyscallMonitor::on_NtRollbackComplete},\
    {"NtRollbackEnlistment", &syscall_mon::SyscallMonitor::on_NtRollbackEnlistment},\
    {"NtRollbackTransaction", &syscall_mon::SyscallMonitor::on_NtRollbackTransaction},\
    {"NtRollforwardTransactionManager", &syscall_mon::SyscallMonitor::on_NtRollforwardTransactionManager},\
    {"NtSaveKeyEx", &syscall_mon::SyscallMonitor::on_NtSaveKeyEx},\
    {"NtSaveKey", &syscall_mon::SyscallMonitor::on_NtSaveKey},\
    {"NtSaveMergedKeys", &syscall_mon::SyscallMonitor::on_NtSaveMergedKeys},\
    {"NtSecureConnectPort", &syscall_mon::SyscallMonitor::on_NtSecureConnectPort},\
    {"NtSetBootEntryOrder", &syscall_mon::SyscallMonitor::on_NtSetBootEntryOrder},\
    {"NtSetBootOptions", &syscall_mon::SyscallMonitor::on_NtSetBootOptions},\
    {"NtSetContextThread", &syscall_mon::SyscallMonitor::on_NtSetContextThread},\
    {"NtSetDebugFilterState", &syscall_mon::SyscallMonitor::on_NtSetDebugFilterState},\
    {"NtSetDefaultHardErrorPort", &syscall_mon::SyscallMonitor::on_NtSetDefaultHardErrorPort},\
    {"NtSetDefaultLocale", &syscall_mon::SyscallMonitor::on_NtSetDefaultLocale},\
    {"NtSetDefaultUILanguage", &syscall_mon::SyscallMonitor::on_NtSetDefaultUILanguage},\
    {"NtSetDriverEntryOrder", &syscall_mon::SyscallMonitor::on_NtSetDriverEntryOrder},\
    {"NtSetEaFile", &syscall_mon::SyscallMonitor::on_NtSetEaFile},\
    {"NtSetEventBoostPriority", &syscall_mon::SyscallMonitor::on_NtSetEventBoostPriority},\
    {"NtSetEvent", &syscall_mon::SyscallMonitor::on_NtSetEvent},\
    {"NtSetHighEventPair", &syscall_mon::SyscallMonitor::on_NtSetHighEventPair},\
    {"NtSetHighWaitLowEventPair", &syscall_mon::SyscallMonitor::on_NtSetHighWaitLowEventPair},\
    {"NtSetInformationDebugObject", &syscall_mon::SyscallMonitor::on_NtSetInformationDebugObject},\
    {"NtSetInformationEnlistment", &syscall_mon::SyscallMonitor::on_NtSetInformationEnlistment},\
    {"NtSetInformationFile", &syscall_mon::SyscallMonitor::on_NtSetInformationFile},\
    {"NtSetInformationJobObject", &syscall_mon::SyscallMonitor::on_NtSetInformationJobObject},\
    {"NtSetInformationKey", &syscall_mon::SyscallMonitor::on_NtSetInformationKey},\
    {"NtSetInformationObject", &syscall_mon::SyscallMonitor::on_NtSetInformationObject},\
    {"NtSetInformationProcess", &syscall_mon::SyscallMonitor::on_NtSetInformationProcess},\
    {"NtSetInformationResourceManager", &syscall_mon::SyscallMonitor::on_NtSetInformationResourceManager},\
    {"NtSetInformationThread", &syscall_mon::SyscallMonitor::on_NtSetInformationThread},\
    {"NtSetInformationToken", &syscall_mon::SyscallMonitor::on_NtSetInformationToken},\
    {"NtSetInformationTransaction", &syscall_mon::SyscallMonitor::on_NtSetInformationTransaction},\
    {"NtSetInformationTransactionManager", &syscall_mon::SyscallMonitor::on_NtSetInformationTransactionManager},\
    {"NtSetInformationWorkerFactory", &syscall_mon::SyscallMonitor::on_NtSetInformationWorkerFactory},\
    {"NtSetIntervalProfile", &syscall_mon::SyscallMonitor::on_NtSetIntervalProfile},\
    {"NtSetIoCompletionEx", &syscall_mon::SyscallMonitor::on_NtSetIoCompletionEx},\
    {"NtSetIoCompletion", &syscall_mon::SyscallMonitor::on_NtSetIoCompletion},\
    {"NtSetLdtEntries", &syscall_mon::SyscallMonitor::on_NtSetLdtEntries},\
    {"NtSetLowEventPair", &syscall_mon::SyscallMonitor::on_NtSetLowEventPair},\
    {"NtSetLowWaitHighEventPair", &syscall_mon::SyscallMonitor::on_NtSetLowWaitHighEventPair},\
    {"NtSetQuotaInformationFile", &syscall_mon::SyscallMonitor::on_NtSetQuotaInformationFile},\
    {"NtSetSecurityObject", &syscall_mon::SyscallMonitor::on_NtSetSecurityObject},\
    {"NtSetSystemEnvironmentValueEx", &syscall_mon::SyscallMonitor::on_NtSetSystemEnvironmentValueEx},\
    {"NtSetSystemEnvironmentValue", &syscall_mon::SyscallMonitor::on_NtSetSystemEnvironmentValue},\
    {"NtSetSystemInformation", &syscall_mon::SyscallMonitor::on_NtSetSystemInformation},\
    {"NtSetSystemPowerState", &syscall_mon::SyscallMonitor::on_NtSetSystemPowerState},\
    {"NtSetSystemTime", &syscall_mon::SyscallMonitor::on_NtSetSystemTime},\
    {"NtSetThreadExecutionState", &syscall_mon::SyscallMonitor::on_NtSetThreadExecutionState},\
    {"NtSetTimerEx", &syscall_mon::SyscallMonitor::on_NtSetTimerEx},\
    {"NtSetTimer", &syscall_mon::SyscallMonitor::on_NtSetTimer},\
    {"NtSetTimerResolution", &syscall_mon::SyscallMonitor::on_NtSetTimerResolution},\
    {"NtSetUuidSeed", &syscall_mon::SyscallMonitor::on_NtSetUuidSeed},\
    {"NtSetValueKey", &syscall_mon::SyscallMonitor::on_NtSetValueKey},\
    {"NtSetVolumeInformationFile", &syscall_mon::SyscallMonitor::on_NtSetVolumeInformationFile},\
    {"NtShutdownSystem", &syscall_mon::SyscallMonitor::on_NtShutdownSystem},\
    {"NtShutdownWorkerFactory", &syscall_mon::SyscallMonitor::on_NtShutdownWorkerFactory},\
    {"NtSignalAndWaitForSingleObject", &syscall_mon::SyscallMonitor::on_NtSignalAndWaitForSingleObject},\
    {"NtSinglePhaseReject", &syscall_mon::SyscallMonitor::on_NtSinglePhaseReject},\
    {"NtStartProfile", &syscall_mon::SyscallMonitor::on_NtStartProfile},\
    {"NtStopProfile", &syscall_mon::SyscallMonitor::on_NtStopProfile},\
    {"NtSuspendProcess", &syscall_mon::SyscallMonitor::on_NtSuspendProcess},\
    {"NtSuspendThread", &syscall_mon::SyscallMonitor::on_NtSuspendThread},\
    {"NtSystemDebugControl", &syscall_mon::SyscallMonitor::on_NtSystemDebugControl},\
    {"NtTerminateJobObject", &syscall_mon::SyscallMonitor::on_NtTerminateJobObject},\
    {"NtTerminateProcess", &syscall_mon::SyscallMonitor::on_NtTerminateProcess},\
    {"NtTerminateThread", &syscall_mon::SyscallMonitor::on_NtTerminateThread},\
    {"NtTraceControl", &syscall_mon::SyscallMonitor::on_NtTraceControl},\
    {"NtTraceEvent", &syscall_mon::SyscallMonitor::on_NtTraceEvent},\
    {"NtTranslateFilePath", &syscall_mon::SyscallMonitor::on_NtTranslateFilePath},\
    {"NtUnloadDriver", &syscall_mon::SyscallMonitor::on_NtUnloadDriver},\
    {"NtUnloadKey2", &syscall_mon::SyscallMonitor::on_NtUnloadKey2},\
    {"NtUnloadKeyEx", &syscall_mon::SyscallMonitor::on_NtUnloadKeyEx},\
    {"NtUnloadKey", &syscall_mon::SyscallMonitor::on_NtUnloadKey},\
    {"NtUnlockFile", &syscall_mon::SyscallMonitor::on_NtUnlockFile},\
    {"NtUnlockVirtualMemory", &syscall_mon::SyscallMonitor::on_NtUnlockVirtualMemory},\
    {"NtUnmapViewOfSection", &syscall_mon::SyscallMonitor::on_NtUnmapViewOfSection},\
    {"NtVdmControl", &syscall_mon::SyscallMonitor::on_NtVdmControl},\
    {"NtWaitForDebugEvent", &syscall_mon::SyscallMonitor::on_NtWaitForDebugEvent},\
    {"NtWaitForKeyedEvent", &syscall_mon::SyscallMonitor::on_NtWaitForKeyedEvent},\
    {"NtWaitForMultipleObjects32", &syscall_mon::SyscallMonitor::on_NtWaitForMultipleObjects32},\
    {"NtWaitForMultipleObjects", &syscall_mon::SyscallMonitor::on_NtWaitForMultipleObjects},\
    {"NtWaitForSingleObject", &syscall_mon::SyscallMonitor::on_NtWaitForSingleObject},\
    {"NtWaitForWorkViaWorkerFactory", &syscall_mon::SyscallMonitor::on_NtWaitForWorkViaWorkerFactory},\
    {"NtWaitHighEventPair", &syscall_mon::SyscallMonitor::on_NtWaitHighEventPair},\
    {"NtWaitLowEventPair", &syscall_mon::SyscallMonitor::on_NtWaitLowEventPair},\
    {"NtWorkerFactoryWorkerReady", &syscall_mon::SyscallMonitor::on_NtWorkerFactoryWorkerReady},\
    {"NtWriteFileGather", &syscall_mon::SyscallMonitor::on_NtWriteFileGather},\
    {"NtWriteFile", &syscall_mon::SyscallMonitor::on_NtWriteFile},\
    {"NtWriteRequestData", &syscall_mon::SyscallMonitor::on_NtWriteRequestData},\
    {"NtWriteVirtualMemory", &syscall_mon::SyscallMonitor::on_NtWriteVirtualMemory},
